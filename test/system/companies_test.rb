...
class CompaniesTest < ApplicationSystemTestCase
  ...
  test "should create company" do
    ...
    fill_in "Detail", with: @company.detail
    fill_in "Fax", with: @company.fax
    fill_in "Kana", with: @company.kana
    fill_in "Name", with: @company.name
    fill_in "Name en", with: @company.name_en
    fill_in "Prefecture code", with: @company.prefecture_code
    fill_in "Public", with: @company.public_id
    fill_in "Tel", with: @company.tel

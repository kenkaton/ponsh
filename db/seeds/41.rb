c = Company.in_prefecture(41).find_or_create_by!(name: '田中酒造', kana: 'たなかしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '大和酒造', kana: 'やまとしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '吉武酒造場', kana: 'よしたけしゅぞうじょう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '基山商店', kana: 'きやましょうてん')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '井手酒造', kana: 'いでしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '宗政酒造', kana: 'むねまさしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '小柳酒造', kana: 'こやなぎしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '天山酒造', kana: 'てんざんしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '光栄菊酒造', kana: 'こうえいぎくしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '千代雀酒造', kana: 'ちよすずめしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '東鶴酒造', kana: 'あずまつるしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '鳴滝酒造', kana: 'なるたきしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '樋渡酒造場', kana: 'ひわたししゅぞうじょう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '古伊万里酒造', kana: 'こいまりしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '天吹酒造', kana: 'あまぶきしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '佐嘉酒造', kana: 'さがしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '中島酒造', kana: 'なかしましゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '矢野酒造', kana: 'やのしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '馬場酒造場', kana: 'ばばしゅぞうじょう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '幸姫酒造', kana: 'さちひめしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '光武酒造場', kana: 'みつたけしゅぞうじょう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '富久千代酒造', kana: 'ふくちよしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '峰松酒造場', kana: 'みねまつしゅぞうじょう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '水頭酒造場', kana: 'すいとうしゅぞうじょう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '五町田酒造', kana: 'ごちょうだしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '瀬頭酒造', kana: 'せとうしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '小松酒造', kana: 'こまつしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '松尾酒造場', kana: 'まつおしゅぞうじょう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '松浦一酒造', kana: 'まつうらいちしゅぞう')
...
c = Company.in_prefecture(41).find_or_create_by!(name: '川浪酒造', kana: 'かわなみしゅぞう')

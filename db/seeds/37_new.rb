...
c = Company.create_or_find_by!(name: '綾菊酒造', kana: 'あやきくしゅぞう')
...
c = Company.create_or_find_by!(name: '勇心酒造', kana: 'ゆうしんしゅぞう')
...
c = Company.create_or_find_by!(name: '岡田酒造', kana: 'おかだしゅぞう')
...
c = Company.create_or_find_by!(name: '小豆島酒造', kana: 'しょうどしましゅぞう')
...
c = Company.create_or_find_by!(name: '西野金陵', kana: 'にしのきんりょう')
...
c = Company.create_or_find_by!(name: '丸尾本店', kana: 'まるおほんてん')
...
c = Company.create_or_find_by!(name: '川鶴酒造', kana: 'かわつるしゅぞう')
...
c = Company.create_or_find_by!(name: '木村中田酒造', kana: 'きむらなかたしゅぞう')

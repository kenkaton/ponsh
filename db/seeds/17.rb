c = Company.create_or_find_by!(name: '武内酒造店', kana: 'たけうちしゅぞうてん')
...
c = Company.create_or_find_by!(name: 'やちや酒造', kana: 'やちやしゅぞう')
...
c = Company.create_or_find_by!(name: '小堀酒造店', kana: 'こぼりしゅぞうてん')
...
c = Company.create_or_find_by!(name: '菊姫', kana: 'きくひめ')
...
c = Company.create_or_find_by!(name: '福光屋', kana: 'ふくみつや')
...
c = Company.create_or_find_by!(name: '松浦酒造', kana: 'まつうらしゅぞう')
...
c = Company.create_or_find_by!(name: '橋本酒造', kana: 'はしもとしゅぞう')
...
c = Company.create_or_find_by!(name: '鹿野酒造', kana: 'かのしゅぞう')
...
c = Company.create_or_find_by!(name: '東酒造', kana: 'ひがししゅぞう')
...
c = Company.create_or_find_by!(name: '農口尚彦研究所', kana: 'のぐちなおひこけんきゅうしょ')
...
c = Company.create_or_find_by!(name: '西出酒造', kana: 'にしでしゅぞう')
...
c = Company.create_or_find_by!(name: '加越', kana: 'かえつ')
...
c = Company.create_or_find_by!(name: '手塚酒造場', kana: 'てづかしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '農口酒造', kana: 'のぐちしゅぞう')
...
c = Company.create_or_find_by!(name: '宮本酒造店', kana: 'みやもとしゅぞうてん')
...
c = Company.create_or_find_by!(name: '車多酒造', kana: 'しゃたしゅぞう')
...
c = Company.create_or_find_by!(name: '吉田酒造店', kana: 'よしだしゅぞうてん')
...
c = Company.create_or_find_by!(name: '金谷酒造店', kana: 'かなやしゅぞうてん')
...
c = Company.create_or_find_by!(name: '春成酒造店', kana: 'はるなりしゅぞうてん')
...
c = Company.create_or_find_by!(name: '布施酒造店', kana: 'ふせしゅぞうてん')
...
c = Company.create_or_find_by!(name: '鶴野酒造店', kana: 'つるのしゅぞうてん')
...
c = Company.create_or_find_by!(name: '数馬酒造', kana: 'かずましゅぞう')
...
c = Company.create_or_find_by!(name: '松波酒造', kana: 'まつなみしゅぞう')
...
c = Company.create_or_find_by!(name: '櫻田酒造', kana: 'さくらだしゅぞう')
...
c = Company.create_or_find_by!(name: '宗玄酒造', kana: 'そうげんしゅぞう')
...
c = Company.create_or_find_by!(name: '沢田酒造店', kana: 'さわだしゅぞうてん')
...
c = Company.create_or_find_by!(name: '日吉酒造店', kana: 'ひよししゅぞうてん')
...
c = Company.create_or_find_by!(name: '清水酒造店', kana: 'しみずしゅぞうてん')
...
c = Company.create_or_find_by!(name: '白藤酒造店', kana: 'はくとうしゅぞうてん')
...
c = Company.create_or_find_by!(name: '中島酒造店', kana: 'なかしましゅぞうてん')
...
c = Company.create_or_find_by!(name: '中納酒造', kana: 'なかのしゅぞう')
...
c = Company.create_or_find_by!(name: '久世酒造店', kana: 'くぜしゅぞうてん')
...
c = Company.create_or_find_by!(name: '見砂酒造', kana: 'みさごしゅぞう')
...
c = Company.create_or_find_by!(name: '御祖酒造', kana: 'みおやしゅぞう')
...
c = Company.create_or_find_by!(name: '二羽鶴酒造場', kana: 'にわづるしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '鳥屋酒造', kana: 'とりやしゅぞう')

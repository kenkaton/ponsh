c = Company.in_prefecture(3).find_or_create_by!(name: '菊の司酒造', kana: 'きくのつかさしゅぞう')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '桜顔酒造', kana: 'さくらがおしゅぞう')
...
c = Company.in_prefecture(3).find_or_create_by!(name: 'あさ開', kana: 'あさびらき')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '赤武酒造', kana: 'あかぶしゅぞう')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '岩手川', kana: 'いわてがわ')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '両磐酒造', kana: 'りょうばんしゅぞう')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '世嬉の一酒造', kana: 'せきのいちしゅぞう')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '天瓢', kana: 'てんぴょう')
address_attrs = { prefecture_code: 3, addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
Brand.find_or_create_by!(name: '蒼天', kana: 'そうてん', company: c)

c = Company.in_prefecture(3).find_or_create_by!(name: '喜久盛酒造', kana: 'きくざかりしゅぞう')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '白雲', kana: 'はくうん')
address_attrs = { prefecture_code: 3, addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.in_prefecture(3).find_or_create_by!(name: '浜千鳥', kana: 'はまちどり')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '菱屋酒造店', kana: 'ひしやしゅぞうてん')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '泉金酒造', kana: 'せんきんしゅぞう')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '上閉伊酒造', kana: 'かみへいしゅぞう')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '民宿とおの', kana: 'とおの')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '宝峰', kana: 'たからみね')
address_attrs = { prefecture_code: 3, addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
Brand.find_or_create_by!(name: '宝峰', kana: 'たからみね', company: c)

c = Company.in_prefecture(3).find_or_create_by!(name: '川村酒造店', kana: 'かわむらしゅぞうてん')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '月の輪酒造店', kana: 'つきのわしゅぞうてん')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '廣田酒造店', kana: 'ひろたしゅぞうてん')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '高橋酒造店', kana: 'たかはししゅぞうてん')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '吾妻嶺酒造店', kana: 'あづまみねしゅぞうてん')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '南部美人', kana: 'なんぶびじん')
...
c = Company.in_prefecture(3).find_or_create_by!(name: 'わしの尾', kana: 'わしのお')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '鈴蘭酒造', kana: 'すずらんしゅぞう')
address_attrs = { prefecture_code: 3, addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.in_prefecture(3).find_or_create_by!(name: '福来', kana: 'ふくらい')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '酔仙酒造', kana: 'すいせんしゅぞう')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '磐乃井酒造', kana: 'いわのいしゅぞう')
...
c = Company.in_prefecture(3).find_or_create_by!(name: '岩手銘醸', kana: 'いわてめいじょう')

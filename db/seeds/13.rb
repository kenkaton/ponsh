c = Company.create_or_find_by!(name: '東京駅酒造場 - TOKYO STATION SAKE BREWERY', kana: 'とうきょうえきしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '東京港醸造', kana: 'とうきょうこうじょうぞう')
...
c = Company.create_or_find_by!(name: '木花之醸造所', kana: 'このはなのじょうぞうしょ')
...
c = Company.create_or_find_by!(name: '野口酒造店', kana: 'のぐちしゅぞうてん')
...
c = Company.create_or_find_by!(name: '豊島屋酒造', kana: 'としまやしゅぞう')
...
c = Company.create_or_find_by!(name: '野崎酒造', kana: 'のざきしゅぞう')
...
c = Company.create_or_find_by!(name: '小澤酒造場', kana: 'おざわしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '中島酒造場', kana: 'なかじましゅぞうじょう')
...
c = Company.create_or_find_by!(name: '田村酒造場', kana: 'たむらしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '小澤酒造', kana: 'おざわしゅぞう')
...
c = Company.create_or_find_by!(name: '土屋酒造', kana: 'つちやしゅぞう')

c = Company.in_prefecture(19).find_or_create_by!(name: '太冠酒造', kana: 'たいかんしゅぞう')
...
c = Company.in_prefecture(19).find_or_create_by!(name: '横内酒造店', kana: 'よこうちしゅぞうてん')
address_attrs = { prefecture_code: 19, city: '南アルプス市', street_address: '上宮地57', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
...
c = Company.in_prefecture(19).find_or_create_by!(name: '萬屋醸造店', kana: 'よろずやじょうぞうてん')
...
c = Company.in_prefecture(19).find_or_create_by!(name: '大久保酒造店', kana: 'おおくぼしゅぞうてん')
...
c = Company.in_prefecture(19).find_or_create_by!(name: '笹一酒造', kana: 'ささいちしゅぞう')
...
c = Company.in_prefecture(19).find_or_create_by!(name: '井出醸造店', kana: 'いでじょうぞうてん')
...
c = Company.in_prefecture(19).find_or_create_by!(name: '養老酒造', kana: 'ようろうしゅぞう')
...
c = Company.in_prefecture(19).find_or_create_by!(name: '腕相撲酒造', kana: 'うでずもうしゅぞう')
...
c = Company.in_prefecture(19).find_or_create_by!(name: '武の井酒造', kana: 'たけのいしゅぞう')
...
c = Company.in_prefecture(19).find_or_create_by!(name: '八巻酒造店', kana: 'やまきしゅぞうてん')
...
c = Company.in_prefecture(19).find_or_create_by!(name: '山梨銘醸', kana: 'やまなしめいじょう')
...
c = Company.in_prefecture(19).find_or_create_by!(name: '谷櫻酒造', kana: 'たにざくらしゅぞう')
...
c = Company.in_prefecture(19).find_or_create_by!(name: '横山酒造店', kana: 'よこやましゅぞうてん')
...
c = Company.in_prefecture(19).find_or_create_by!(name: '二葉屋酒造店', kana: 'ふたばやしゅぞうてん')

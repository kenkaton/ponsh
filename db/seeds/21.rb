c = Company.create_or_find_by!(name: '足立酒造', kana: 'あだちしゅぞう')
...
c = Company.create_or_find_by!(name: '日本泉酒造', kana: 'にほんいずみしゅぞう')
...
c = Company.create_or_find_by!(name: '柴田酒造', kana: 'しばたしゅぞう')
...
c = Company.create_or_find_by!(name: '杉原酒造', kana: 'すぎはらしゅぞう')
...
c = Company.create_or_find_by!(name: '所酒造', kana: 'ところしゅぞう')
...
c = Company.create_or_find_by!(name: '白木恒助商店', kana: 'しらきつねすけしょうてん')
...
c = Company.create_or_find_by!(name: '松井屋酒造場', kana: 'まついやしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '小坂酒造場', kana: 'こさかしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '平野本店', kana: 'ひらのほんてん')
...
c = Company.create_or_find_by!(name: '平野醸造', kana: 'ひらのじょうぞう')
...
c = Company.create_or_find_by!(name: '原酒造場', kana: 'はらしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '久納酒造', kana: 'くのしゅぞう')
...
c = Company.create_or_find_by!(name: '千代菊', kana: 'ちよぎく')
...
c = Company.create_or_find_by!(name: '林彰一郎商店', kana: 'はやししょういちろうしょうてん')
...
c = Company.create_or_find_by!(name: '渡辺酒造醸', kana: 'わたなべしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '吉田合資', kana: 'よしだごうし')
...
c = Company.create_or_find_by!(name: '武内酒造', kana: 'たけうちしゅぞう')
...
c = Company.create_or_find_by!(name: '玉泉堂酒造', kana: 'ぎょくせんどうしゅぞう')
...
c = Company.create_or_find_by!(name: '小町酒造', kana: 'こまちしゅぞう')
...
c = Company.create_or_find_by!(name: '林本店', kana: 'はやしほんてん')
...
c = Company.create_or_find_by!(name: '御代桜醸造', kana: 'みよざくらじょうぞう')
...
c = Company.create_or_find_by!(name: '平井酒造場', kana: 'ひらいしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '古田酒造', kana: 'ふるたしゅぞう')
...
c = Company.create_or_find_by!(name: '花盛酒造', kana: 'はなもりしゅぞう')
...
c = Company.create_or_find_by!(name: '蔵元やまだ', kana: 'くらもとやまだ')
...
c = Company.create_or_find_by!(name: '田辺酒造場', kana: 'たなべしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '平瀬酒造店', kana: 'ひらせしゅぞうてん')
...
c = Company.create_or_find_by!(name: '二木酒造', kana: 'にきしゅぞう')
...
c = Company.create_or_find_by!(name: '川尻酒造場', kana: 'かわじりしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '平田酒造場', kana: 'ひらたしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '原田酒造場', kana: 'はらだしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '老田酒造店', kana: 'おいたしゅぞうてん')
...
c = Company.create_or_find_by!(name: '舩坂酒造店', kana: 'ふなさかしゅぞうてん')
...
c = Company.create_or_find_by!(name: '大坪酒造店', kana: 'おおつぼしゅぞうてん')
...
c = Company.create_or_find_by!(name: '三千盛', kana: 'みちさかり')
...
c = Company.create_or_find_by!(name: 'はざま酒造', kana: 'はざましゅぞう')
...
c = Company.create_or_find_by!(name: '恵那醸造', kana: 'えなじょうぞう')
...
c = Company.create_or_find_by!(name: '菊川', kana: 'きくかわ')
...
c = Company.create_or_find_by!(name: '平和錦酒造', kana: 'へいわにしきしゅぞう')
...
c = Company.create_or_find_by!(name: '白扇酒造', kana: 'はくせんしゅぞう')
...
c = Company.create_or_find_by!(name: '奥飛騨酒造', kana: 'おくひだしゅぞう')
...
c = Company.create_or_find_by!(name: '天領酒造', kana: 'てんりょうしゅぞう')
...
c = Company.create_or_find_by!(name: '蒲酒造場', kana: 'かばしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '千古乃岩酒造', kana: 'ちごのいわしゅぞう')
...
c = Company.create_or_find_by!(name: '中島醸造', kana: 'なかしまじょうぞう')
...
c = Company.create_or_find_by!(name: '若葉', kana: 'わかば')
...
c = Company.create_or_find_by!(name: '白梅酒造', kana: 'しらうめしゅぞう')
...
c = Company.create_or_find_by!(name: 'いとう鶴酒造', kana: 'いとうつるしゅぞう')
...
c = Company.create_or_find_by!(name: '岩村醸造', kana: 'いわむらじょうぞう')
...
c = Company.create_or_find_by!(name: '大橋酒造', kana: 'おおはししゅぞう')
...
c = Company.create_or_find_by!(name: '山内酒造場', kana: 'やまうちしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '丸田屋酒造', kana: 'まるたやしゅぞう')

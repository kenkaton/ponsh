c = Company.create_or_find_by!(name: '越後・謙信SAKEまつり', kana: 'えちごけんしんさけまつり')
...
c = Company.create_or_find_by!(name: '美の川酒造', kana: 'みのがわしゅぞう')
...
c = Company.create_or_find_by!(name: '越銘醸', kana: 'こしめいじょう')
...
c = Company.create_or_find_by!(name: '諸橋酒造', kana: 'もろはししゅぞう')
...
c = Company.create_or_find_by!(name: '長谷川酒造', kana: 'はせがわしゅぞう')
...
c = Company.create_or_find_by!(name: 'お福酒造', kana: 'おふくしゅぞう')
...
c = Company.create_or_find_by!(name: '柏露酒造', kana: 'はくろしゅぞう')
...
c = Company.create_or_find_by!(name: '恩田酒造', kana: 'おんだしゅぞう')
...
c = Company.create_or_find_by!(name: '吉乃川', kana: 'よしのがわ')
...
c = Company.create_or_find_by!(name: '関原酒造', kana: 'せきはらしゅぞう')
...
c = Company.create_or_find_by!(name: '栃倉酒造', kana: 'とちくらしゅぞう')
...
c = Company.create_or_find_by!(name: '河忠酒造', kana: 'かわちゅうしゅぞう')
...
c = Company.create_or_find_by!(name: '住乃井酒造', kana: 'すみのいしゅぞう')
...
c = Company.create_or_find_by!(name: '猪又酒造', kana: 'いのまたしゅぞう')
...
c = Company.create_or_find_by!(name: '加賀の井酒造', kana: 'かがのいしゅぞう')
...
c = Company.create_or_find_by!(name: '池田屋酒造', kana: 'いけだやしゅぞう')
...
c = Company.create_or_find_by!(name: '丸山酒造場', kana: 'まるやましゅぞうじょう')
...
c = Company.create_or_find_by!(name: '新潟第一酒造', kana: 'にいがただいいちしゅぞう')
...
c = Company.create_or_find_by!(name: '上越酒造', kana: 'じょうえつしゅぞう')
...
c = Company.create_or_find_by!(name: '新潟県酒造組合 高田支部', kana: 'にいがたけんしゅぞうくみあい たかだしぶ')
...
c = Company.create_or_find_by!(name: '武蔵野酒造', kana: 'むさしのしゅぞう')
...
c = Company.create_or_find_by!(name: '妙高酒造', kana: 'みょうこうしゅぞう')
...
c = Company.create_or_find_by!(name: '君の井酒造', kana: 'きみのいしゅぞう')
...
c = Company.create_or_find_by!(name: '千代の光酒造', kana: 'ちよのひかりしゅぞう')
...
c = Company.create_or_find_by!(name: '加茂乃井酒造', kana: 'かものいしゅぞう')
...
c = Company.create_or_find_by!(name: '谷乃井酒造', kana: 'たにのいしゅぞう')
address_attrs = { prefecture_code: 15, city: '上越市板倉区', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.create_or_find_by!(name: '鮎正宗酒造', kana: 'あゆまさむねしゅぞう')
...
c = Company.create_or_find_by!(name: '原酒造', kana: 'はらしゅぞう')
...
c = Company.create_or_find_by!(name: '阿部酒造', kana: 'あべしゅぞう')
...
c = Company.create_or_find_by!(name: '林酒造場', kana: 'はやししゅぞうじょう')
...
c = Company.create_or_find_by!(name: '石塚酒造', kana: 'いしづかしゅぞう')
...
c = Company.create_or_find_by!(name: '緑川酒造', kana: 'みどりかわしゅぞう')
...
c = Company.create_or_find_by!(name: '玉川酒造', kana: 'たまがわしゅぞう')
...
c = Company.create_or_find_by!(name: '新潟銘醸', kana: 'にいがためいじょう')
...
c = Company.create_or_find_by!(name: '高の井酒造', kana: 'たかのいしゅぞう')
...
c = Company.create_or_find_by!(name: '松乃井酒造場', kana: 'まつのいしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '渡辺酒造店', kana: 'わたなべしゅぞうてん')
...
c = Company.create_or_find_by!(name: '小山酒造店', kana: 'こやましゅぞうてん')
...
c = Company.create_or_find_by!(name: '竹田酒造店', kana: 'たけだしゅぞうてん')
...
c = Company.create_or_find_by!(name: '頚城酒造', kana: 'くびきしゅぞう')
...
c = Company.create_or_find_by!(name: '代々菊醸造', kana: 'よよぎくじょうぞう')
...
c = Company.create_or_find_by!(name: '加藤酒造', kana: 'かとうしゅぞう')
...
c = Company.create_or_find_by!(name: 'よしかわ杜氏の郷', kana: 'よしかわとうじのさと')
...
c = Company.create_or_find_by!(name: '久須美酒造', kana: 'くすみしゅぞう')
...
c = Company.create_or_find_by!(name: '池浦酒造', kana: 'いけうらしゅぞう')
...
c = Company.create_or_find_by!(name: '白瀧酒造', kana: 'しらたきしゅぞう')
...
c = Company.create_or_find_by!(name: '高千代酒造', kana: 'たかちよしゅぞう')
...
c = Company.create_or_find_by!(name: '八海醸造', kana: 'はっかいじょうぞう')
...
c = Company.create_or_find_by!(name: '苗場酒造', kana: 'なえばしゅぞう')
...
c = Company.create_or_find_by!(name: '津南醸造', kana: 'つなんじょうぞう')
...
c = Company.create_or_find_by!(name: '魚沼酒造', kana: 'うおぬましゅぞう')
...
c = Company.create_or_find_by!(name: '今代司酒造', kana: 'いまよつかさしゅぞう')
...
c = Company.create_or_find_by!(name: '越の華酒造', kana: 'こしのはなしゅぞう')
...
c = Company.create_or_find_by!(name: '石本酒造', kana: 'いしもとしゅぞう')
...
c = Company.create_or_find_by!(name: '塩川酒造', kana: 'しおかわしゅぞう')
...
c = Company.create_or_find_by!(name: '樋木酒造', kana: 'ひきしゅぞう')
...
c = Company.create_or_find_by!(name: '濱倉酒造', kana: 'はまくらしゅぞう')
address_attrs = { prefecture_code: 15, city: '新潟市', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.create_or_find_by!(name: '高野酒造', kana: 'たかのしゅぞう')
...
c = Company.create_or_find_by!(name: '越後伝衛門', kana: 'えちごでんえもん')
...
c = Company.create_or_find_by!(name: '越後酒造場', kana: 'えちごしゅぞうじょう')
...
c = Company.create_or_find_by!(name: 'DHC酒造', kana: 'でぃえいちしぃしゅぞう')
...
c = Company.create_or_find_by!(name: '天領盃酒造', kana: 'てんりょうはいしゅぞう')
...
c = Company.create_or_find_by!(name: '逸見酒造', kana: 'へんみしゅぞう')
...
c = Company.create_or_find_by!(name: '菊波酒造', kana: 'きくなみしゅぞう')
...
c = Company.create_or_find_by!(name: '尾畑酒造', kana: 'おばたしゅぞう')
...
c = Company.create_or_find_by!(name: '北雪酒造', kana: 'ほくせつしゅぞう')
...
c = Company.create_or_find_by!(name: '加藤酒造店', kana: 'かとうしゅぞうてん')
...
c = Company.create_or_find_by!(name: '佐渡発酵', kana: 'さどはっこう')
...
c = Company.create_or_find_by!(name: '笹祝酒造', kana: 'ささいわいしゅぞう')
...
c = Company.create_or_find_by!(name: '越後鶴亀', kana: 'えちごつるかめ')
...
c = Company.create_or_find_by!(name: '峰乃白梅酒造', kana: 'みねのはくばいしゅぞう')
...
c = Company.create_or_find_by!(name: '宝山酒造', kana: 'たからやましゅぞう')
...
c = Company.create_or_find_by!(name: '福顔酒造', kana: 'ふくがおしゅぞう')
...
c = Company.create_or_find_by!(name: '村祐酒造', kana: 'むらゆうしゅぞう')
...
c = Company.create_or_find_by!(name: '金升酒造', kana: 'かねますしゅぞう')
...
c = Company.create_or_find_by!(name: '王紋酒造', kana: 'おうもんしゅぞう')
...
c = Company.create_or_find_by!(name: 'ふじの井酒造', kana: 'ふじのいしゅぞう')
...
c = Company.create_or_find_by!(name: '大洋酒造', kana: 'たいようしゅぞう')
...
c = Company.create_or_find_by!(name: '宮尾酒造', kana: 'みやおしゅぞう')
...
c = Company.create_or_find_by!(name: '弥彦酒造', kana: 'やひこしゅぞう')
...
c = Company.create_or_find_by!(name: '朝妻酒造', kana: 'あさづましゅぞう')
...
c = Company.create_or_find_by!(name: '加茂錦酒造', kana: 'かもにしきしゅぞう')
...
c = Company.create_or_find_by!(name: '雪椿酒造', kana: 'ゆきつばきしゅぞう')
...
c = Company.create_or_find_by!(name: 'マスカガミ', kana: 'ますかがみ')
...
c = Company.create_or_find_by!(name: '金鵄盃酒造', kana: 'きんしはいしゅぞう')
...
c = Company.create_or_find_by!(name: '越後桜酒造', kana: 'えちござくらしゅぞう')
...
c = Company.create_or_find_by!(name: '白龍酒造', kana: 'はくりゅうしゅぞう')
...
c = Company.create_or_find_by!(name: '越つかの酒造', kana: 'こしつかのしゅぞう')
...
c = Company.create_or_find_by!(name: '下越酒造', kana: 'かえつしゅぞう')
...
c = Company.create_or_find_by!(name: '麒麟山酒造', kana: 'きりんざんしゅぞう')

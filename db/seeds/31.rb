...
c = Company.create_or_find_by!(name: '君司酒造', kana: 'きみつかさしゅぞう')
...
c = Company.create_or_find_by!(name: '高田酒造場', kana: 'たかだしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '高田酒造', kana: 'たかたしゅぞう')
...
c = Company.create_or_find_by!(name: '元帥酒造', kana: 'げんすいしゅぞう')
...
c = Company.create_or_find_by!(name: '中井酒造', kana: 'なかいしゅぞう')
...
c = Company.create_or_find_by!(name: '稲田本店', kana: 'いなだほんてん')
...
c = Company.create_or_find_by!(name: '千代むすび酒造', kana: 'ちよむすびしゅぞう')
...
c = Company.create_or_find_by!(name: '西本酒造場', kana: 'にしもとしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '山根酒造場', kana: 'やまねしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '福羅酒造', kana: 'ふくらしゅぞう')
...
c = Company.create_or_find_by!(name: '諏訪酒造', kana: 'すわしゅぞう')
...
c = Company.create_or_find_by!(name: '梅津酒造', kana: 'うめづしゅぞう')
...
c = Company.create_or_find_by!(name: '江原酒造本店', kana: 'えばらしゅぞうほんてん')
...
c = Company.create_or_find_by!(name: '大谷酒造', kana: 'おおたにしゅぞう')
...
c = Company.create_or_find_by!(name: '久米桜酒造', kana: 'くめざくらしゅぞう')
...
c = Company.create_or_find_by!(name: '上代', kana: 'かみだい')
...
c = Company.create_or_find_by!(name: '大岩酒造本店', kana: 'おおいわしゅぞうほんてん')

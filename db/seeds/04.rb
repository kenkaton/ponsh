# 宮城県の酒造会社
c = Company.create_or_find_by!(name: 'DATE SEVEN', kana: 'だてせぶん')
...
c = Company.create_or_find_by!(name: '千松島', kana: 'ちまつしま')
...
c = Company.create_or_find_by!(name: '吉岡酒造店', kana: 'よしおかしゅぞうてん')
...
c = Company.create_or_find_by!(name: '佐々木酒造店', kana: 'ささきしゅぞうてん')
...
c = Company.create_or_find_by!(name: '宮城酒類', kana: 'みやぎしゅるい')
address_attrs = { prefecture_code: 4, city: '仙台市', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
Brand.find_or_create_by!(name: '雪の松島', kana: 'ゆきのまつしま', company: c)

c = Company.create_or_find_by!(name: '仙台伊澤家 勝山酒造', kana: 'かつやましゅぞう')
...
c = Company.create_or_find_by!(name: '内ヶ崎酒造店', kana: 'うちがさきしゅぞうてん')
...
c = Company.create_or_find_by!(name: '大和蔵酒造', kana: 'たいわぐらしゅぞう')
...
c = Company.create_or_find_by!(name: '中勇酒造店', kana: 'なかゆうしゅぞうてん')
...
c = Company.create_or_find_by!(name: '山和酒造店', kana: 'やまわしゅぞうてん')
...
c = Company.create_or_find_by!(name: '森民酒造本家', kana: 'もりたみしゅぞうほんけ')
...
c = Company.create_or_find_by!(name: '鳳山酒造', kana: 'ほうざんしゅぞう')
...
c = Company.create_or_find_by!(name: '佐浦', kana: 'さうら')
...
c = Company.create_or_find_by!(name: '麹屋酒造店', kana: 'こうじやしゅぞうてん')
...
c = Company.create_or_find_by!(name: '阿部勘酒造店', kana: 'あべかんしゅぞうてん')
...
c = Company.create_or_find_by!(name: '石川酒造店', kana: 'いしかわしゅぞうてん')
...
c = Company.create_or_find_by!(name: '墨廼江酒造', kana: 'すみのえしゅぞう')
...
c = Company.create_or_find_by!(name: '平孝酒造', kana: 'ひらこうしゅぞう')
...
c = Company.create_or_find_by!(name: '一ノ蔵', kana: 'いちのくら')
...
c = Company.create_or_find_by!(name: 'はさまや酒造店', kana: 'はさまやしゅぞうてん')
...
c = Company.create_or_find_by!(name: '金の井酒造', kana: 'かねのいしゅぞう')
...
c = Company.create_or_find_by!(name: '門傳醸造', kana: 'もんでんじょうぞう')
...
c = Company.create_or_find_by!(name: '角星', kana: 'かくぼし')
...
c = Company.create_or_find_by!(name: '男山本店', kana: 'おとこやまほんてん')
...
c = Company.create_or_find_by!(name: '蔵王酒造', kana: 'ざおうしゅぞう')
...
c = Company.create_or_find_by!(name: '大沼酒造店', kana: 'おおぬましゅぞうてん')
...
c = Company.create_or_find_by!(name: '相傳商店', kana: 'あいでんしょうてん')
...
c = Company.create_or_find_by!(name: '川敬商店', kana: 'かわけいしょうてん')
...
c = Company.create_or_find_by!(name: '石越醸造', kana: 'いしこしじょうぞう')
...
c = Company.create_or_find_by!(name: '萩野酒造', kana: 'はぎのしゅぞう')
...
c = Company.create_or_find_by!(name: '千田酒造', kana: 'ちだしゅぞう')
...
c = Company.create_or_find_by!(name: '宮城ふるさと酒造', kana: 'みやぎふるさとしゅぞう')
...
c = Company.create_or_find_by!(name: '橋平酒造店', kana: 'はしへいしゅぞうてん')
...
c = Company.create_or_find_by!(name: '浅勘酒造店', kana: 'あさかんしゅぞうてん')
...
c = Company.create_or_find_by!(name: '新澤醸造店', kana: 'にいざわじょうぞうてん')
...
c = Company.create_or_find_by!(name: '森民酒造店', kana: 'もりたみしゅぞうてん')

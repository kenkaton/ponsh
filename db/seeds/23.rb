c = Company.in_prefecture(23).find_or_create_by!(name: '伊勢屋商店', kana: 'いせやしょうてん')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '日野屋商店', kana: 'ひのやしょうてん')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '関谷醸造', kana: 'せきやじょうぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '福井酒造', kana: 'ふくいしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '白井醸造', kana: 'しらいじょうぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '丸石醸造', kana: 'まるいしじょうぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '山﨑合資会社', kana: 'やまざきごうしがいしゃ')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '中垣酒造', kana: 'なかがきしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '柴田酒造場', kana: 'しばたしゅぞうじょう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '相生ユニビオ', kana: 'あいおいゆにびお')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '神杉酒造', kana: 'かみすぎしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '永井酒造場', kana: 'ながいしゅぞうじょう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '清洲桜醸造', kana: 'きよすざくらじょうぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '八束穂酒造', kana: 'やつかほしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '常盤醸造', kana: 'ときわじょうぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '山盛酒造', kana: 'やまもりしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '神の井酒造', kana: 'かみのいしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '萬乗醸造', kana: 'ばんじょうじょうぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '双葉酒造', kana: 'ふたばしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '金虎酒造', kana: 'きんとらしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '東春酒造', kana: 'とうしゅんしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '浦野', kana: 'うらの')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '野村酒造', kana: 'のむらしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '原田酒造', kana: 'はらだしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '丸一酒造', kana: 'まるいちしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '内田酒造', kana: 'うちだしゅぞう')
address_attrs = { prefecture_code: 23, city: '知多郡', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.in_prefecture(23).find_or_create_by!(name: '豊田酒造', kana: 'とよたしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '伊東', kana: 'いとう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '盛田金しゃち酒造', kana: 'もりたきんしゃちしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '中埜酒造', kana: 'なかのしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '盛田', kana: 'もりた')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '澤田酒造', kana: 'さわだしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '勲碧酒造', kana: 'くんぺきしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '丸井合名', kana: 'まるいごうめい')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '山星酒造', kana: 'やまぼししゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '小弓鶴酒造', kana: 'こゆみつるしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '東洋自慢酒造', kana: 'とうようじまんしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '金銀花酒造', kana: 'きんぎんかしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '藤市酒造', kana: 'ふじいちしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '内藤醸造', kana: 'ないとうじょうぞう') # 内藤釀造
...
c.contact || c.create_contact!(contact_attrs)
Brand.find_or_create_by!(name: '武陵桃源', kana: 'ぶりょうとうげん', company: c)
Brand.find_or_create_by!(name: '桃源郷', kana: 'とうげんきょう', company: c)
Brand.find_or_create_by!(name: '氷の精', kana: 'こおりのせい', company: c)
Brand.find_or_create_by!(name: '木曽三川', kana: 'きそさんせん', company: c)


c = Company.in_prefecture(23).find_or_create_by!(name: '鶴見酒造', kana: 'つるみしゅぞう')
...
c.contact || c.create_contact!(contact_attrs)
Brand.find_or_create_by!(name: '我山', kana: 'がざん', company: c)
Brand.find_or_create_by!(name: '山荘', kana: 'さんそう', company: c)
Brand.find_or_create_by!(name: '神鶴', kana: 'かみつる', company: c)
Brand.find_or_create_by!(name: '夢乃寒梅', kana: 'ゆめのかんばい', company: c)


c = Company.in_prefecture(23).find_or_create_by!(name: '長珍酒造', kana: 'ちょうちんしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '山忠本家酒造', kana: 'やまちゅうほんけしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '山忠新家', kana: 'やまちゅうしんけ')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '青木酒造', kana: 'あおきしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '渡辺酒造', kana: 'わたなべしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '水谷酒造', kana: 'みずたにしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '山田酒造', kana: 'やまだしゅぞう')
...
c = Company.in_prefecture(23).find_or_create_by!(name: '甘強酒造', kana: 'かんきょうしゅぞう')

...
c = Company.create_or_find_by!(name: '株式会社 旅酒', kana: 'たびさけ')
...
c = Company.create_or_find_by!(name: '大矢孝酒造', kana: 'おやたかししゅぞう')
...
c = Company.create_or_find_by!(name: '泉橋酒造', kana: 'いずみばししゅぞう')
...
c = Company.create_or_find_by!(name: '相田酒造店', kana: 'あいだしゅぞうてん')
...
c = Company.create_or_find_by!(name: '舞姿酒造', kana: 'まいすがたしゅぞう')
...
c = Company.create_or_find_by!(name: '熊澤酒造', kana: 'くまざわしゅぞう')
...
c = Company.create_or_find_by!(name: '中沢酒造', kana: 'なかざわしゅぞう')
...
c = Company.create_or_find_by!(name: '石井醸造', kana: 'いしいじょうぞう')
...
c = Company.create_or_find_by!(name: '瀬戸酒造店', kana: 'せとしゅぞうてん')
...
c = Company.create_or_find_by!(name: '川西屋酒造店', kana: 'かわにしやしゅぞうてん')
...
c = Company.create_or_find_by!(name: '吉川醸造', kana: 'きっかわじょうぞう')
...
c = Company.create_or_find_by!(name: '金井酒造店', kana: 'かねいしゅぞうてん')

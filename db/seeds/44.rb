c = Company.in_prefecture(44).find_or_create_by!(name: '倉光酒造', kana: 'そうこうしゅぞう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '久保酒蔵', kana: 'くぼしゅぞう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '宇佐酒類', kana: 'うさしゅるい')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '小松酒造場', kana: 'こまつしゅぞうじょう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '江本商店', kana: 'えもとしょうてん')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '民潮酒舗', kana: 'みんちょうしゅほ')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '大分銘醸', kana: 'おおいためいじょう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '中野酒造', kana: 'なかのしゅぞう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '矢野酒造場', kana: 'やのしゅぞうじょう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '萱島酒造', kana: 'かやしましゅぞう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '久家本店', kana: 'くげほんてん')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '小手川酒造', kana: 'こてがわしゅぞう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '藤居酒造', kana: 'ふじいしゅぞう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '赤嶺酒造場', kana: 'あかみねしゅぞうじょう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '大地酒造', kana: 'おおちしゅぞう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: 'クンチョウ酒造', kana: 'くんちょうしゅぞう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '井上酒造', kana: 'いのうえしゅぞう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '老松酒造', kana: 'おいまつしゅぞう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '佐藤酒造', kana: 'さとうしゅぞう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '西の誉銘醸', kana: 'にしのほまれめいじょう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '常徳屋酒造場', kana: 'じょうとくやしゅぞうじょう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '三和酒類', kana: 'さんわしゅるい')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '山田酒造場', kana: 'やまだしゅぞうじょう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '小野酒造', kana: 'おのしゅぞう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: 'ぶんご銘醸', kana: 'ぶんごめいじょう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '小掠酒造', kana: 'おぐらしゅぞう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '亀の井酒造', kana: 'かめのいしゅぞう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '八鹿酒造', kana: 'やつしかしゅぞう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '麻生本店', kana: 'あそうほんてん')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '牟礼鶴酒造', kana: 'むれづるしゅぞう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '丹誠酒類', kana: 'たんせいしゅるい')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '吉良酒造', kana: 'きらしゅぞう')
...
c = Company.in_prefecture(44).find_or_create_by!(name: '浜嶋酒造', kana: 'はましましゅぞう')

c = Company.in_prefecture(22).find_or_create_by!(name: '高嶋酒造', kana: 'たかしましゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '万大醸造', kana: 'ばんだいじょうぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '根上酒造店', kana: 'ねがみしゅぞうてん')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '富士高砂酒造', kana: 'ふじたかさごしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '富士正酒造', kana: 'ふじまさしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '牧野酒造', kana: 'まきのしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '富士錦酒造', kana: 'ふじにしきしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '君盃酒造', kana: 'くんぱいしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '静岡平喜酒造', kana: 'しずおかひらきしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '多々良酒造場', kana: 'たたらしゅぞうじょう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '初亀醸造', kana: 'はつかめじょぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '満寿一酒造', kana: 'ますいちしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '英君酒造', kana: 'えいくんしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '神沢川酒造場', kana: 'かんざわがわしゅぞうじょう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '萩錦酒造', kana: 'はぎにしきしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '駿河酒造場', kana: 'するがしゅぞうじょう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '三和酒造', kana: 'さんわしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '磯自慢酒造', kana: 'いそじまんしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '杉井酒造', kana: 'すぎいしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '青島酒造', kana: 'あおしましゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '岩本酒造', kana: 'いわもとしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '志太泉酒造', kana: 'しだいずみしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '大村屋酒造場', kana: 'おおむらやしゅぞうじょう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '浜松酒造', kana: 'はままつしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '花の舞酒造', kana: 'はなのまいしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '國香酒造', kana: 'こっこうしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '山中酒造', kana: 'やまなかしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '土井酒造場', kana: 'どいしゅぞうじょう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '石川酒造', kana: 'いしかわしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '千寿酒造', kana: 'せんじゅしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '森本酒造', kana: 'もりもとしゅぞう')
...
c = Company.in_prefecture(22).find_or_create_by!(name: '白松酒造', kana: 'しらまつしゅぞう')

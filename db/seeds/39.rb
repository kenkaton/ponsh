c = Company.in_prefecture(39).find_or_create_by!(name: '酔鯨酒造', kana: 'すいげいしゅぞう')
...
c = Company.in_prefecture(39).find_or_create_by!(name: '亀泉酒造', kana: 'かめいずみしゅぞう')
...
c = Company.in_prefecture(39).find_or_create_by!(name: '高知酒造', kana: 'こうちしゅぞう')
...
c = Company.in_prefecture(39).find_or_create_by!(name: '土佐酒造', kana: 'とさしゅぞう')
...
c = Company.in_prefecture(39).find_or_create_by!(name: '高木酒造', kana: 'たかぎしゅぞう')
...
c.contact || c.create_contact!(contact_attrs)
Brand.find_or_create_by!(name: '豊能梅', kana: 'とよのうめ', company: c)
...
c = Company.in_prefecture(39).find_or_create_by!(name: '仙頭酒造場', kana: 'せんとうしゅぞうじょう')
...
c = Company.in_prefecture(39).find_or_create_by!(name: '浜川商店', kana: 'はまかわしょうてん')
...
c = Company.in_prefecture(39).find_or_create_by!(name: '南酒造場', kana: 'みなみしゅぞうじょう')
...
c = Company.in_prefecture(39).find_or_create_by!(name: '土佐鶴酒造', kana: 'とさつるしゅぞう')
...
c = Company.in_prefecture(39).find_or_create_by!(name: 'アリサワ', kana: 'ありさわ')
...
c = Company.in_prefecture(39).find_or_create_by!(name: '松尾酒造', kana: 'まつおしゅぞう')
...
c = Company.in_prefecture(39).find_or_create_by!(name: '菊水酒造', kana: 'きくすいしゅぞう')
...
c = Company.in_prefecture(39).find_or_create_by!(name: '有光酒造場', kana: 'ありみつしゅぞうじょう')
...
c = Company.in_prefecture(39).find_or_create_by!(name: '文本酒造', kana: 'ふみもとしゅぞう')
...
c = Company.in_prefecture(39).find_or_create_by!(name: '無手無冠', kana: 'むてむか')
...
c = Company.in_prefecture(39).find_or_create_by!(name: '藤娘酒造', kana: 'ふじむすめしゅぞう')
...
c = Company.in_prefecture(39).find_or_create_by!(name: '司牡丹酒造', kana: 'つかさぼたんしゅぞう')
...
c = Company.in_prefecture(39).find_or_create_by!(name: '西岡酒造店', kana: 'にしおかしゅぞうてん')

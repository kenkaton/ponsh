c = Company.in_prefecture(34).find_or_create_by!(name: '田中酒造', kana: 'たなかしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '三輪酒造', kana: 'みわしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '美の鶴酒造', kana: 'みのつるしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '天宝一', kana: 'てんぽういち')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '高橋酒造', kana: 'たかはししゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '吉源酒造場', kana: 'よしげんしゅぞうじょう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '濱岡酒造', kana: 'はまおかしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '備南酒造', kana: 'びなんしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '醉心山根本店', kana: 'すいしんやまねほんてん')
address_attrs = { prefecture_code: 34, city: '三原市', street_address: '東町1-5-58', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
contact_attrs = { tel: '0848-62-3251', fax: '0848-62-3253', website: 'https://www.suishinsake.co.jp', contactable_type: 'Company' }
c.contact || c.create_contact!(contact_attrs)
Brand.find_or_create_by!(name: '醉心', kana: 'すいしん', company: c)
Brand.find_or_create_by!(name: 'ブナのしずく', kana: 'ぶなのしずく', company: c)


c = Company.in_prefecture(34).find_or_create_by!(name: '金光酒造', kana: 'かねみつしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '竹鶴酒造', kana: 'たけつるしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '藤井酒造', kana: 'ふじいしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '中尾醸造', kana: 'なかおじょうぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '比婆美人酒造', kana: 'ひばびじんしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '白蘭酒造', kana: 'はくらんしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '本郷酒造', kana: 'ほんごうしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '喜久牡丹酒造', kana: 'きくぼたんしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '今田酒造本店', kana: 'いまだしゅぞうほんてん')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '柄酒造', kana: 'つかしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '盛川酒造', kana: 'もりかわしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '花酔酒造', kana: 'はなよいしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '山岡酒造', kana: 'やまおかしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '福六酒造', kana: 'ふくろくしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '北村醸造場', kana: 'きたむらじょうぞうじょう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '生熊酒造', kana: 'いくましゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '美和桜酒造', kana: 'みわさくらしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '原本店', kana: 'はらほんてん')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '安佐酒造', kana: 'あさしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '久保田酒造', kana: 'くぼたしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '旭鳳酒造', kana: 'きょくほうしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '有木酒造場', kana: 'ありきしゅぞうじょう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '千豊酒造', kana: 'せんぽうしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '小野酒造', kana: 'おのしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '上杉酒造', kana: 'うえすぎしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '福光酒造', kana: 'ふくみつしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '玉扇酒造', kana: 'たまおうぎしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '川本酒造場', kana: 'かわもとしゅぞうじょう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '馬上酒造場', kana: 'ばじょうしゅぞうじょう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '八幡川酒造', kana: 'やはたがわしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '広島県立総合技術研究所 食品工業技術センター', kana: 'ひろしまけんりつそうごうぎじゅつけんきゅうしょ しょくひんこうぎょうぎじゅつせんたー')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '小泉本店', kana: 'こいずみほんてん')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '梅田酒造場', kana: 'うめだしゅぞうじょう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '白天龍酒造場', kana: 'はくてんりゅうしゅぞうじょう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '三宅本店', kana: 'みやけほんてん')
...
Brand.find_or_create_by!(name: '黒松', kana: 'くろまつ', company: c)


c = Company.in_prefecture(34).find_or_create_by!(name: '宝剣酒造', kana: 'ほうけんしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '相原酒造', kana: 'あいはらしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '中野光次郎本店', kana: 'なかのみつじろうほんてん')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '榎酒造', kana: 'えのきしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '藤岡酒造店', kana: 'ふじおかしゅぞうてん')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '林酒造', kana: 'はやししゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '江田島銘醸', kana: 'えたじまめいじょう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '津田酒造', kana: 'つだしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '中国醸造', kana: 'ちゅうごくじょうぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '賀茂泉酒造', kana: 'かもいずみしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '亀齢酒造', kana: 'きれいしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '白牡丹酒造', kana: 'はくぼたんしゅぞう')
...
Brand.find_or_create_by!(name: '芳華金紋', kana: 'ほうかきんもん', company: c)


c = Company.in_prefecture(34).find_or_create_by!(name: '福美人酒造', kana: 'ふくびじんしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '西條鶴醸造', kana: 'さいじょうつるしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '賀茂鶴酒造', kana: 'かもつるしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '山陽鶴酒造', kana: 'さんようつるしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '賀茂輝酒造', kana: 'かもきしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '千代乃春酒造', kana: 'ちよのはるしゅぞう')
address_attrs = { prefecture_code: 34, city: '東広島市', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.in_prefecture(34).find_or_create_by!(name: '田熊酒造', kana: 'たぐましゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '藤高酒造', kana: 'ふじたかしゅぞう')
...
c = Company.in_prefecture(34).find_or_create_by!(name: '向原酒造', kana: 'むかいはらしゅぞう')

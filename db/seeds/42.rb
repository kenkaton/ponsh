c = Company.in_prefecture(42).find_or_create_by!(name: '重家酒造', kana: 'おもやしゅぞう')
...
c = Company.in_prefecture(42).find_or_create_by!(name: '壱岐の蔵酒造', kana: 'いきのくらしゅぞう')
...
c = Company.in_prefecture(42).find_or_create_by!(name: '河内酒造', kana: 'かわちしゅぞう')
...
c = Company.in_prefecture(42).find_or_create_by!(name: '杵の川', kana: 'きのかわ')
...
c = Company.in_prefecture(42).find_or_create_by!(name: 'あい娘酒造', kana: 'あいむすめしゅぞう')
...
c = Company.in_prefecture(42).find_or_create_by!(name: '山崎本店酒造場', kana: 'やまさきほんてんしゅぞうじょう')
...
c = Company.in_prefecture(42).find_or_create_by!(name: '西牟田酒造場', kana: 'にしむたしゅぞうじょう')
...
c = Company.in_prefecture(42).find_or_create_by!(name: '伊藤酒造場', kana: 'いとうしゅぞうじょう')
...
c = Company.in_prefecture(42).find_or_create_by!(name: '太田酒造場', kana: 'おおたしゅぞうじょう')
...
c = Company.in_prefecture(42).find_or_create_by!(name: '加藤酒造場', kana: 'かとうしゅぞうじょう')
...
c = Company.in_prefecture(42).find_or_create_by!(name: '吉田屋', kana: 'よしだや')
...
c = Company.in_prefecture(42).find_or_create_by!(name: '浦川酒造', kana: 'うらかわしゅぞう')
...
c = Company.in_prefecture(42).find_or_create_by!(name: '梅ヶ枝酒造', kana: 'うめがえしゅぞう')
...
c = Company.in_prefecture(42).find_or_create_by!(name: '今里酒造', kana: 'いまざとしゅぞう')
...
c = Company.in_prefecture(42).find_or_create_by!(name: '森酒造場', kana: 'もりしゅぞうじょう')
...
c = Company.in_prefecture(42).find_or_create_by!(name: '福田酒造', kana: 'ふくだしゅぞう')
...
Brand.find_or_create_by!(name: '福海', kana: 'ふくうみ', company: c)
Brand.find_or_create_by!(name: '初恋音', kana: 'はつこいね', company: c)
Brand.find_or_create_by!(name: 'Giyaman', kana: 'ギヤマン', company: c)


c = Company.in_prefecture(42).find_or_create_by!(name: '潜龍酒造', kana: 'せんりゅうしゅぞう')

c = Company.in_prefecture(10).find_or_create_by!(name: '山崎酒造', kana: 'やまざきしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '山川酒造', kana: 'やまかわしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '岡村合名', kana: 'おかむらごうめい')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '美峰酒類', kana: 'みほうしゅるい')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '町田酒造店', kana: 'まちだしゅぞうてん')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '井田酒造', kana: 'いだしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '藤﨑摠兵衛商店 鬼石支店', kana: 'ふじさきそうべえしょうてん おにししてん')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '聖徳銘醸', kana: 'せいとくめいじょう')
address_attrs = { prefecture_code: 10, city: '甘楽郡', street_address: '甘楽町白倉686-1', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
contact_attrs = { tel: '0274-74-4111', fax: '0274-74-6325', website: 'https://seitoku.co.jp', contactable_type: 'Company' }
c.contact || c.create_contact!(contact_attrs)
Brand.find_or_create_by!(name: '鳳凰聖徳', kana: 'ほうおうせいとく', company: c)
...
c = Company.in_prefecture(10).find_or_create_by!(name: '牧野酒造', kana: 'まきのしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '柴崎酒造', kana: 'しばさきしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '伴内酒造店', kana: 'ばんないしゅぞうてん')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '柳澤酒造', kana: 'やなぎさわしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '七ツ星醸造', kana: 'ななつぼしじょうぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '太刀川酒造', kana: 'たちかわしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '島岡酒造', kana: 'しまおかしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '今井酒造店', kana: 'いまいしゅぞうてん')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '分福酒造', kana: 'ぶんぶくしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '龍神酒造', kana: 'りゅうじんしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '清水屋酒造', kana: 'しみずやしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '松屋酒造', kana: 'まつやしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '田島酒造店', kana: 'たじましゅぞうてん')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '高井', kana: 'たかい')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '奥村酒造', kana: 'おくむらしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '近藤酒造', kana: 'こんどうしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '聖酒造', kana: 'ひじりしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '貴娘酒造', kana: 'きむすめしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '浅間酒造', kana: 'あさましゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '永井本家', kana: 'ながいほんけ')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '土田酒造', kana: 'つちだしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '永井酒造', kana: 'ながいしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '大利根酒造', kana: 'おおとねしゅぞう')
...
c = Company.in_prefecture(10).find_or_create_by!(name: '森本酒造', kana: 'もりもとしゅぞう')
address_attrs = { prefecture_code: 10, city: '前橋市', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)

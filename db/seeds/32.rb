c = Company.create_or_find_by!(name: '隠岐酒造', kana: 'おきしゅぞう')
...
c = Company.create_or_find_by!(name: '天佑酒造', kana: 'てんゆうしゅぞう')
...
c = Company.create_or_find_by!(name: '米田酒造', kana: 'よねだしゅぞう')
...
c = Company.create_or_find_by!(name: '國暉酒造', kana: 'こっきしゅぞう')
...
c = Company.create_or_find_by!(name: '李白酒造', kana: 'りはくしゅぞう')
...
c = Company.create_or_find_by!(name: '田部竹下酒造', kana: 'たなべたけしたしゅぞう')
...
c = Company.create_or_find_by!(name: '竹下本店', kana: 'たけしたほんてん')
...
c = Company.create_or_find_by!(name: '赤名酒造', kana: 'あかなしゅぞう')
...
c = Company.create_or_find_by!(name: '酒持田本店', kana: 'さけもちだほんてん')
...
c = Company.create_or_find_by!(name: '天界酒造', kana: 'てんかいしゅぞう')
...
c = Company.create_or_find_by!(name: '金鳳酒造', kana: 'きんぽうしゅぞう')
...
c = Company.create_or_find_by!(name: '青砥酒造', kana: 'あおとしゅぞう')
...
c = Company.create_or_find_by!(name: '富士酒造', kana: 'ふじしゅぞう')
...
c = Company.create_or_find_by!(name: '旭日酒造', kana: 'あさひしゅぞう')
...
c = Company.create_or_find_by!(name: '板倉酒造', kana: 'いたくらしゅぞう')
...
c = Company.create_or_find_by!(name: '一宮酒造', kana: 'いちのみやしゅぞう')
...
c = Company.create_or_find_by!(name: '都錦酒造', kana: 'みやこにしきしゅぞう')
...
c = Company.create_or_find_by!(name: '加茂福酒造', kana: 'かもふくしゅぞう')
...
c = Company.create_or_find_by!(name: '玉櫻酒造', kana: 'たまざくらしゅぞう')
...
c = Company.create_or_find_by!(name: '池月酒造', kana: 'いけづきしゅぞう')
...
c = Company.create_or_find_by!(name: '三桜酒造', kana: 'みつざくらしゅぞう')
...
c = Company.create_or_find_by!(name: '右田本店', kana: 'みぎたほんてん')
...
c = Company.create_or_find_by!(name: '岡田屋本店', kana: 'おかだやほんてん')
...
c = Company.create_or_find_by!(name: '中原酒造', kana: 'なかはらしゅぞう')
...
c = Company.create_or_find_by!(name: '桑原酒場', kana: 'くわばらさかば')
...
c = Company.create_or_find_by!(name: '王祿酒造', kana: 'おうろくしゅぞう')
...
c = Company.create_or_find_by!(name: '台雲酒造', kana: 'たいうんしゅぞう')
...
c = Company.create_or_find_by!(name: '大社正宗醸造', kana: 'たいしゃまさむねじょうぞう')
...
c = Company.create_or_find_by!(name: '立花酒造場', kana: 'たちばなしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '木次酒造', kana: 'きすきしゅぞう')
...
c = Company.create_or_find_by!(name: '奥出雲酒造', kana: 'おくいずもしゅぞう')
...
c = Company.create_or_find_by!(name: '簸上清酒', kana: 'ひかみせいしゅ')
...
c = Company.create_or_find_by!(name: '若林酒造', kana: 'わかばやししゅぞう')
...
c = Company.create_or_find_by!(name: '日本海酒造', kana: 'にほんかいしゅぞう')
...
c = Company.create_or_find_by!(name: '下森酒造場', kana: 'したもりしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '古橋酒造', kana: 'ふるはししゅぞう')
...
c = Company.create_or_find_by!(name: '石州酒造', kana: 'せきしゅうしゅぞう')
...
c = Company.create_or_find_by!(name: '華泉酒造', kana: 'かせんしゅぞう')
...
c = Company.create_or_find_by!(name: '財間酒場', kana: 'ざいまさかば')

c = Company.in_prefecture(8).find_or_create_by!(name: '賜杯桜酒造', kana: 'しはいざくらしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '浦里酒造店', kana: 'うらざとしゅぞうてん')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '山中酒造店', kana: 'やまなかしゅぞうてん')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '野村醸造', kana: 'のむらじょうぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '稲葉酒造', kana: 'いなばしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '村井醸造', kana: 'むらいじょうぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '西岡本店', kana: 'にしおかほんてん')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '軽部酒造店', kana: 'かるべしゅぞうてん')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '来福酒造', kana: 'らいふくしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '岡田酒造店', kana: 'おかだしゅぞうてん')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '田中酒造店', kana: 'たなかしゅぞうてん')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '金門酒造', kana: 'きんもんしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '竹村酒造店', kana: 'たけむらしゅぞうてん')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '青木酒造', kana: 'あおきしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '萩原酒造', kana: 'はぎわらしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '大塚酒造', kana: 'おおつかしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '武勇', kana: 'ぶゆう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '結城酒造', kana: 'ゆうきしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '堀川酒造店', kana: 'ほりかわしゅぞうてん')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '武藤酒類醸造', kana: 'むとうしゅるいじょうぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '笹目宗兵衛商店', kana: 'ささめそうべえしょうてん')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '磯蔵酒造', kana: 'いそくらしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '須藤本家', kana: 'すどうほんけ')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '瀧田酒造店', kana: 'たきたしゅぞうじょう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '吉久保酒造', kana: 'よしくぼしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '明利酒類', kana: 'めいりしゅるい')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '木内酒造', kana: 'きうちしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '檜山酒造', kana: 'ひやましゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '井坂酒造店', kana: 'いさかしゅぞうてん')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '東魁酒造', kana: 'とうかいしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '月の井酒造店', kana: 'つきのいしゅぞうてん')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '愛友酒造', kana: 'あいゆうしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '遠峰酒造', kana: 'とおみねしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '伊能酒造店', kana: 'いのうしゅぞうてん')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '竹乃葉酒造', kana: 'たけのはしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '岡部合名', kana: 'おかべごうめい')
...
Brand.find_or_create_by!(name: '昼下がりのランデヴー', kana: 'ひるさがりのらんでぶー', company: c)
...
c = Company.in_prefecture(8).find_or_create_by!(name: '剛烈酒造', kana: 'ごうれつしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '太田銘醸', kana: 'おおためいじょう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '府中誉', kana: 'ふちゅうほまれ')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '石岡酒造', kana: 'いしおかしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '廣瀬商店', kana: 'ひろせしょうてん')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '藤田酒造店', kana: 'ふじたしゅぞうてん')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '嶋崎酒造', kana: 'しまざきしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '菊乃香酒造', kana: 'きくのかしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '椎名酒造店', kana: 'しいなしゅぞうてん')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '森島酒造', kana: 'もりしましゅぞう')
...
Brand.find_or_create_by!(name: '富士大観', kana: 'ふじたいかん', company: c)


c = Company.in_prefecture(8).find_or_create_by!(name: '住の友酒造', kana: 'すみのともしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '浅川酒造', kana: 'あさかわしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '酔富銘醸', kana: 'すいふめいじょう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '根本酒造', kana: 'ねもとしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '珂北酒造', kana: 'かほくしゅぞう')
...
c = Company.in_prefecture(8).find_or_create_by!(name: '家久長本店', kana: 'かくちょうほんてん')

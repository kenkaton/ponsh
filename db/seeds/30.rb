c = Company.in_prefecture(30).find_or_create_by!(name: '初光酒造', kana: 'はつひかりしゅぞう')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '中尾酒造店', kana: 'なかおしゅぞうてん')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '通宝酒造', kana: 'つうほうしゅぞう')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '平和酒造', kana: 'へいわしゅぞう')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '天長島村酒造', kana: 'てんちょうしまむらしゅぞう')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '世界一統', kana: 'せかいいっとう')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '田端酒造', kana: 'たばたしゅぞう')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '祝砲酒造', kana: 'しゅくほうしゅぞう')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '名手酒造店', kana: 'なてしゅぞうてん')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '中野ＢＣ', kana: 'なかのびぃしぃ')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '島本酒造場', kana: 'しまもとしゅぞうじょう')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '平松酒造本家', kana: 'ひらまつしゅぞうほんけ')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '高垣酒造', kana: 'たかがきしゅぞう')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '岸野酒造本家', kana: 'きしのしゅぞうほんけ')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '鈴木宗右衛門酒造', kana: 'すずきそうえもんしゅぞう')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '尾崎酒造', kana: 'おざきしゅぞう')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '九重雑賀', kana: 'ここのえさいか')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '吉村秀雄商店', kana: 'よしむらひでおしょうてん')
...
c = Company.in_prefecture(30).find_or_create_by!(name: '初桜酒造', kana: 'はつさくらしゅぞう')
address_attrs = { prefecture_code: 30, city: '伊都郡', street_address: 'かつらぎ町中飯降85', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
contact_attrs = { tel: '0736-22-0005', fax: '0736-22-2324', website: 'https://hatsusakurashuzo.com/', contactable_type: 'Company' }
c.contact || c.create_contact!(contact_attrs)
b = Brand.find_or_create_by!(name: '般若湯', kana: 'こうやさんはんにゃとう', company: c)
Product.find_or_create_by!(name: '高野山聖般若湯', kana: 'こうやさんしょうはんにゃとう', brand: b)
Product.find_or_create_by!(name: '高野山般若湯', kana: 'こうやさんはんにゃとう', brand: b)
Brand.find_or_create_by!(name: '初桜', kana: 'はつさくら', company: c)
Brand.find_or_create_by!(name: '酔人日', kana: 'すいじんび', company: c)

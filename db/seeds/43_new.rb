c = Company.create_or_find_by!(name: '山都酒造', kana: 'やまとしゅぞう')
...
c = Company.create_or_find_by!(name: '熊本県酒造研究所', kana: 'くまもとけんしゅぞうけんきゅうしょ')
...
c = Company.create_or_find_by!(name: '千代の園酒造', kana: 'ちよのそのしゅぞう')
...
c = Company.create_or_find_by!(name: '花の香酒造', kana: 'はなのかしゅぞう')
...
c = Company.create_or_find_by!(name: '菊の城本舗', kana: 'きくのしろほんぽ')
...
c = Company.create_or_find_by!(name: '美少年', kana: 'びしょうねん')
...
c = Company.create_or_find_by!(name: '通潤酒造', kana: 'つうじゅんしゅぞう')
...
c = Company.create_or_find_by!(name: '瑞鷹酒造', kana: 'ずいようしゅぞう')
...
c = Company.create_or_find_by!(name: '堤酒造', kana: 'つつみしゅぞう')
...
c = Company.create_or_find_by!(name: '山村酒造', kana: 'やまむらしゅぞう')
...
c = Company.create_or_find_by!(name: '室原酒造', kana: 'むろはらしゅぞう')
...
c = Company.create_or_find_by!(name: '河津酒造', kana: 'かわづしゅぞう')
...
c = Company.create_or_find_by!(name: '亀萬酒造', kana: 'かめまんしゅぞう')

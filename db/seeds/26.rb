c = Company.in_prefecture(26).find_or_create_by!(name: '宝酒造', kana: 'たからしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '羽田酒造', kana: 'はねだしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '佐々木酒造', kana: 'ささきしゅぞう')
...
c.contact || c.create_contact!(contact_attrs)
Brand.find_or_create_by!(name: '聚楽第', kana: 'じゅらくだい', company: c) # 聚樂第
...
c = Company.in_prefecture(26).find_or_create_by!(name: '京都酒造組合', kana: 'きょうとしゅぞうくみあい')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '松井酒造', kana: 'まついしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '城陽酒造', kana: 'じょうようしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '東山酒造', kana: 'ひがしやましゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '山本本家', kana: 'やまもとほんけ')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '藤岡酒造', kana: 'ふじおかしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '平和酒造', kana: 'へいわしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '都鶴酒造', kana: 'みやこつるしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '松山酒造', kana: 'まつやましゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '玉乃光酒造', kana: 'たまのひかりしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '鶴正酒造', kana: 'つるまさしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '日々醸造', kana: 'にちにちじょうぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '共同酒造', kana: 'きょうどうしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '山本勘蔵商店', kana: 'やまもとかんぞうしょうてん')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '松本酒造', kana: 'まつもとしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '齊藤酒造', kana: 'さいとうしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '黄桜酒造', kana: 'きざくらしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '豊澤本店', kana: 'とよさわほんてん')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '招徳酒造', kana: 'しょうとくしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '京姫酒造', kana: 'きょうひめしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '北川本家', kana: 'きたがわほんけ')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '名誉冠酒造', kana: 'めいよかんしゅぞう')
address_attrs = { prefecture_code: 26, city: '京都市伏見区', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
Brand.find_or_create_by!(name: '名誉冠', kana: 'めいよかん', company: c)
...
c = Company.in_prefecture(26).find_or_create_by!(name: '増田徳兵衛商店', kana: 'ますだとくべえしょうてん')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '月桂冠', kana: 'げっけいかん')
...
c = Company.in_prefecture(26).find_or_create_by!(name: 'キンシ正宗', kana: 'きんしまさむね')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '京都酒造', kana: 'きょうとしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '相綴酒造', kana: 'そうてつしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '河守醸造', kana: 'こうもりじょうぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '東和酒造', kana: 'とうわしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '岡野酒造場', kana: 'おかのしゅぞうじょう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '大石酒造', kana: 'おおいししゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '丹山酒造', kana: 'たんざんしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '関酒造', kana: 'せきしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '三盛酒造', kana: 'さんせいしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '若宮酒造', kana: 'わかみやしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '池田酒造', kana: 'いけだしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: 'ハクレイ酒造', kana: 'はくれいしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '向井酒造', kana: 'むかいしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '峰山酒造', kana: 'みねやましゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '吉岡酒造場', kana: 'よしおかしゅぞうじょう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '竹野酒造', kana: 'たけのしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '永雄酒造', kana: 'ながおしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '長老', kana: 'ちょうろう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '白糸酒造', kana: 'しらいとしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '細井酒造', kana: 'ほそいしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '与謝娘酒造', kana: 'よさむすめしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '谷口酒造', kana: 'たにぐちしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '白杉酒造', kana: 'しらすぎしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '大同酒造', kana: 'だいどうしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '熊野酒造', kana: 'くまのしゅぞう')
...
c = Company.in_prefecture(26).find_or_create_by!(name: '木下酒造', kana: 'きのしたしゅぞう')

c = Company.create_or_find_by!(name: '富山酒造組合', kana: 'とやましゅぞうくみあい')
...
c = Company.create_or_find_by!(name: '有澤酒造店', kana: 'ありさわしゅぞうてん')
...
c = Company.create_or_find_by!(name: '富美菊酒造', kana: 'ふみぎくしゅぞう')
...
c = Company.create_or_find_by!(name: '白岩', kana: 'しらいわ')
...
c = Company.create_or_find_by!(name: '桝田酒造店', kana: 'ますだしゅぞうてん')
...
c = Company.create_or_find_by!(name: '若駒酒造場', kana: 'わかこましゅぞうじょう')
...
c = Company.create_or_find_by!(name: '黒田酒造', kana: 'くろだしゅぞう')
...
c = Company.create_or_find_by!(name: '日本晴酒造', kana: 'にほんばれしゅぞう')
...
c = Company.create_or_find_by!(name: '清都酒造場', kana: 'きよとしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '高澤酒造場', kana: 'たかざわしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '藤波酒造', kana: 'ふじなみしゅぞう')
...
c = Company.create_or_find_by!(name: '千代鶴酒造', kana: 'ちよづるしゅぞう')
...
c = Company.create_or_find_by!(name: '魚津酒造', kana: 'うおづしゅぞう')
...
c = Company.create_or_find_by!(name: '皇国晴酒造', kana: 'みくにはれしゅぞう')
...
c = Company.create_or_find_by!(name: '銀盤酒造', kana: 'ぎんばんしゅぞう')
...
c = Company.create_or_find_by!(name: '戸出酒造', kana: 'といでしゅぞう')
...
c = Company.create_or_find_by!(name: '若鶴酒造', kana: 'わかつるしゅぞう')
...
c = Company.create_or_find_by!(name: '立山酒造', kana: 'たてやましゅぞう')
...
c = Company.create_or_find_by!(name: '吉江酒造', kana: 'よしえしゅぞう')
...
c = Company.create_or_find_by!(name: '成政酒造', kana: 'なりまさしゅぞう')
...
c = Company.create_or_find_by!(name: '三笑楽酒造', kana: 'さんしょうらくしゅぞう')
...
c = Company.create_or_find_by!(name: '玉旭酒造', kana: 'たまあさひしゅぞう')
...
c = Company.create_or_find_by!(name: '福鶴酒造', kana: 'ふくつるしゅぞう')
...
c = Company.create_or_find_by!(name: '吉乃友酒造', kana: 'よしのともしゅぞう')

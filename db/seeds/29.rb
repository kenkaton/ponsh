c = Company.in_prefecture(29).find_or_create_by!(name: '中本酒造店', kana: 'なかもとしゅぞうてん')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '上田酒造', kana: 'うえだしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '菊司醸造', kana: 'きくつかさじょうぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '錦生醸造', kana: 'きんせいじょうぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '奈良春日山酒造', kana: 'ならかすがやましゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '今西清兵衛商店', kana: 'いまにしせいべえしょうてん')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '奈良豊澤酒造', kana: 'ならとよさわしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '増田酒造', kana: 'ますだしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '稲田酒造', kana: 'いなだしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '宮崎酒造', kana: 'みやざきしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '多山酒造', kana: 'たやましゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '倉本酒造', kana: 'くらもとしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '西田酒造', kana: 'にしだしゅぞう')
address_attrs = { prefecture_code: 29, city: '奈良市', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.in_prefecture(29).find_or_create_by!(name: '今西酒造', kana: 'いまにししゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '西内酒造場', kana: 'にしうちしゅぞうじょう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '岡野酒造', kana: 'おかのしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '久保本家酒造', kana: 'くぼほんけしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '芳村酒造', kana: 'よしむらしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '喜多酒造', kana: 'きたしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '岸の竹酒造', kana: 'きしのたけしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '脇本酒造', kana: 'わきもとしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '河合酒造', kana: 'かわいしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '金剛力酒造', kana: 'こんごうりきしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '長龍酒造', kana: 'ちょうりょうしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '太田酒造', kana: 'おおたしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '五條酒造', kana: 'ごじょうしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '山本本家', kana: 'やまもとほんけ')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '藤村酒造', kana: 'ふじむらしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '岡本本家', kana: 'おかもとほんけ')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '澤田酒造', kana: 'さわだしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '大倉本家', kana: 'おおくらほんけ')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '井上酒造', kana: 'いのうえしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '中川酒造', kana: 'なかがわしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '中谷酒造', kana: 'なかたにしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '梅乃宿酒造', kana: 'うめのやどしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '岸本酒造', kana: 'きしもとしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '油長酒造', kana: 'ゆうちょうしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '千代酒造', kana: 'ちよしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '葛城酒造', kana: 'かつらぎしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '北岡本店', kana: 'きたおかほんてん')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '北村酒造', kana: 'きたむらしゅぞう')
...
c = Company.in_prefecture(29).find_or_create_by!(name: '美吉野醸造', kana: 'みよしのじょうぞう')

c = Company.in_prefecture(11).find_or_create_by!(name: '大瀧酒造', kana: 'おおたきしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '小山本家酒造', kana: 'こやまほんけしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '内木酒造', kana: 'うちきしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '鈴木酒造', kana: 'すずきしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '石井酒造', kana: 'いしいしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '関口酒造', kana: 'せきぐちしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '寒梅酒造', kana: 'かんばいしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '釜屋', kana: 'かまや')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '清水酒造', kana: 'しみずしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '南陽醸造', kana: 'なんようじょうぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '東亜酒造', kana: 'とうあしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '神亀酒造', kana: 'しんかめしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '清龍酒造', kana: 'せいりゅうしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '小江戸鏡山酒造', kana: 'こえどかがみやましゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '日本酒造', kana: 'にほんしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '佐藤酒造店', kana: 'さとうしゅぞうてん')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '越生酒造', kana: 'おごせしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '麻原酒造', kana: 'あさはらしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '長澤酒造', kana: 'ながさわしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '松岡醸造', kana: 'まつおかじょうぞう') # 松岡釀造
...
c = Company.in_prefecture(11).find_or_create_by!(name: '晴雲酒造', kana: 'せいうんしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '武蔵鶴酒造', kana: 'むさしつるしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '五十嵐酒造', kana: 'いがらししゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '有馬錦酒造', kana: 'ありまにしきしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '権田酒造', kana: 'ごんだしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '横田酒造', kana: 'よこたしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '川端酒造', kana: 'かわばたしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '北西酒造', kana: 'きたにししゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '秋笹醸造', kana: 'あきささじょうぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '丸山酒造', kana: 'まるやましゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '藤橋藤三郎商店', kana: 'ふじはしとうざぶろうしょうてん')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '滝澤酒造', kana: 'たきざわしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '横関酒造', kana: 'よこぜきしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '武甲酒造', kana: 'ぶこうしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '矢尾本店', kana: 'やおほんてん')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '藤﨑摠兵衛商店', kana: 'ふじさきそうべえしょうてん')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '藤﨑摠兵衛商店 長瀞蔵', kana: 'ふじさきそうべえしょうてん ながとろぐら')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '秩父菊水酒造', kana: 'ちちぶきくすいしゅぞう')
...
c = Company.in_prefecture(11).find_or_create_by!(name: '和久井酒造', kana: 'わくいしゅぞう')

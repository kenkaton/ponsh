c = Company.create_or_find_by!(name: '宮﨑本店', kana: 'みやざきほんてん')
...
c = Company.create_or_find_by!(name: '清水清三郎商店', kana: 'しみずせいざぶろうしょうてん')
...
c = Company.create_or_find_by!(name: '小川本家', kana: 'おがわほんけ')
...
c = Company.create_or_find_by!(name: '神楽酒造', kana: 'かぐらしゅぞう')
...
c = Company.create_or_find_by!(name: '早川酒造', kana: 'はやかわしゅぞう')
...
c = Company.create_or_find_by!(name: 'タカハシ酒造', kana: 'たかはししゅぞう')
...
c = Company.create_or_find_by!(name: '安達本家酒造', kana: 'あだちほんけしゅぞう')
...
c = Company.create_or_find_by!(name: '稲垣酒造場', kana: 'いながきしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '早川酒造部', kana: 'はやかわしゅぞうぶ')
...
c = Company.create_or_find_by!(name: '細川酒造', kana: 'ほそかわしゅぞう')
...
c = Company.create_or_find_by!(name: '丸彦酒造', kana: 'まるひこしゅぞう')
...
c = Company.create_or_find_by!(name: '寒紅梅酒造', kana: 'かんこうばいしゅぞう')
...
c = Company.create_or_find_by!(name: '油正', kana: 'あぶしょう')
...
c = Company.create_or_find_by!(name: '松島酒造', kana: 'まつしましゅぞう')
...
c = Company.create_or_find_by!(name: '新良酒造', kana: 'にらしゅぞう')
...
c = Company.create_or_find_by!(name: '中山酒造', kana: 'なかやましゅぞう')
...
c = Company.create_or_find_by!(name: '船木酒造', kana: 'ふなきしゅぞう')
...
c = Company.create_or_find_by!(name: '海野酒造', kana: 'うんのしゅぞう')
address_attrs = { prefecture_code: 24, city: '津市', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.create_or_find_by!(name: '伊勢萬', kana: 'いせまん')
...
c = Company.create_or_find_by!(name: '森喜酒造場', kana: 'もりきしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '福井酒造場', kana: 'ふくいしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '大田酒造', kana: 'おおたしゅぞう')
...
c = Company.create_or_find_by!(name: '若戎酒造', kana: 'わかえびすしゅぞう')
...
c = Company.create_or_find_by!(name: '澤佐酒造', kana: 'さわさしゅぞう')
...
c = Company.create_or_find_by!(name: '瀧自慢酒造', kana: 'たきじまんしゅぞう')
...
c = Company.create_or_find_by!(name: '福持酒造場', kana: 'ふくもちしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '森本仙右衛門商店', kana: 'もりもとせんうえもんしょうてん')
...
c = Company.create_or_find_by!(name: '中井酒造場', kana: 'なかいしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '橋本酒造場', kana: 'はしもとしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '清水酒造場', kana: 'しみずしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '河武醸造', kana: 'かわぶじょうぞう')
...
c = Company.create_or_find_by!(name: '福和蔵', kana: 'ふくわぐら')
...
c = Company.create_or_find_by!(name: '元坂酒造', kana: 'げんさかしゅぞう')

c = Company.in_prefecture(18).find_or_create_by!(name: '美川酒造場', kana: 'みかわしゅぞうじょう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '越の磯', kana: 'こしのいそ')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '菊桂酒造', kana: 'きくかつらしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '久保田酒造', kana: 'くぼたしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '舟木酒造', kana: 'ふなきしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '常山酒造', kana: 'とこやましゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '黒龍酒造', kana: 'こくりゅうしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '田邊酒造', kana: 'たなべしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '吉田酒造', kana: 'よしだしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '毛利酒造', kana: 'もうりしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '安本酒造', kana: 'やすもとしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '力泉酒造', kana: 'りきせんしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '伊藤酒造', kana: 'いとうしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '吉田金右衛門商店', kana: 'よしだきんえもんしょうてん')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '西岡河村酒造', kana: 'にしおかかわむらしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '中村酒造', kana: 'なかむらしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '一本義久保本店', kana: 'いっぽんぎくぼほんてん')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '佐々木酒造', kana: 'ささきしゅぞう')
address_attrs = { prefecture_code: 18, city: '勝山市', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.in_prefecture(18).find_or_create_by!(name: '宇野酒造場', kana: 'うのしゅぞうじょう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '源平酒造', kana: 'げんぺいしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '南部酒造場', kana: 'なんぶしゅぞうじょう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '真名鶴酒造', kana: 'まなつるしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '敦賀酒造', kana: 'つるがしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '寿喜娘酒造', kana: 'すきむすめしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: 'タナベ', kana: 'たなべ')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '片山酒造', kana: 'かたやましゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '加藤吉平商店', kana: 'かとうきちべいしょうてん')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '金鱗酒造', kana: 'きんりんしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '井波酒造', kana: 'いなみしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '豊酒造', kana: 'ゆたかしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '丹生酒造', kana: 'にゅうしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '朝日酒造', kana: 'あさひしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: 'わかさ冨士', kana: 'わかさふじ')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '小浜酒造', kana: 'おばましゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '若狭井酒造', kana: 'わかさいしゅぞう')
address_attrs = { prefecture_code: 18, city: '小浜市', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.in_prefecture(18).find_or_create_by!(name: '増永酒造', kana: 'ますながしゅぞう')
address_attrs = { prefecture_code: 18, city: '福井市', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.in_prefecture(18).find_or_create_by!(name: '田嶋酒造', kana: 'たじましゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '池田酒造', kana: 'いけだしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '北善商店', kana: 'きたぜんしょうてん')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '堀口酒造', kana: 'ほりぐちしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '畠山酒造', kana: 'はたけやましゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '白駒酒造', kana: 'はくこましゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '坪三酒造', kana: 'つぼさんしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '越前酒造', kana: 'えちぜんしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '三宅彦右衛門酒造', kana: 'みやけひこうえもんしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '若狭菊酒造', kana: 'わかさぎくしゅぞう')
...
c = Company.in_prefecture(18).find_or_create_by!(name: '鳥浜酒造', kana: 'とりはましゅぞう')

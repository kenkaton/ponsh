c = Company.in_prefecture(35).find_or_create_by!(name: '八百新酒造', kana: 'やおしんしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '酒井酒造', kana: 'さかいしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '堀江酒場', kana: 'ほりえさかば')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '村重酒造', kana: 'むらしげしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '旭酒造', kana: 'あさひしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '川村酒造場', kana: 'かわむらしゅぞうじょう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '金分銅酒造', kana: 'きんふんどうしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: 'はつもみぢ', kana: 'はつもみぢ')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '山縣本店', kana: 'やまがたほんてん')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '冨永酒造', kana: 'とみながしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '中島屋酒造場', kana: 'なかじまやしゅぞうじょう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '新中野工業 宝眞珠蔵', kana: 'しんなかのこうぎょう たからしんじゅぐら')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '中村酒場', kana: 'なかむらしゅじょう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '男自慢酒造', kana: 'おとこじまんしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '松田酒造', kana: 'まつだしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '竹内酒造場', kana: 'たけうちしゅぞうじょう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '新谷酒造', kana: 'あらやしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '長州酒造', kana: 'ちょうしゅうしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '下関酒造', kana: 'しものせきしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '山城屋酒造', kana: 'やましろやしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '三浦酒造', kana: 'みうらしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '瀧口酒造', kana: 'たきぐちしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '大嶺酒造', kana: 'おおみねしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '金光酒造', kana: 'かねみつしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '三井酒造場', kana: 'みいしゅぞうじょう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '永山酒造', kana: 'ながやましゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '中村酒造', kana: 'なかむらしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '一○酒造', kana: 'いちまるしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '岩崎酒造', kana: 'いわさきしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '大丸酒造', kana: 'だいまるしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '岡崎酒造場', kana: 'おかざきしゅぞうじょう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '白井酒造本店', kana: 'しらいしゅぞうほんてん')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '八千代酒造', kana: 'やちよしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '永山本家酒造場', kana: 'ながやまほんけしゅぞうじょう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '澄川酒造場', kana: 'すみかわしゅぞうじょう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '阿武の鶴酒造', kana: 'あぶのつるしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '山根酒造', kana: 'やまねしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '小崎酒造', kana: 'こさきしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '大津酒類醸造', kana: 'おおつしゅるいじょうぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '西谷酒造', kana: 'にしたにしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '明寿酒造', kana: 'めいじゅしゅぞう')
...
c = Company.in_prefecture(35).find_or_create_by!(name: '琴泉酒造', kana: 'きんせんしゅぞう')

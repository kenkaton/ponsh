c = Company.create_or_find_by!(name: 'Future4', kana: 'ふゅーちゃーふぉー')
...
c = Company.create_or_find_by!(name: 'あおもり酒米プロジェクト', kana: 'あおもりさかまいぷろじぇくと')
address_attrs = { prefecture_code: 2, addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
Brand.find_or_create_by!(name: '三ツ友恵', kana: 'みつどもえ', company: c)

c = Company.create_or_find_by!(name: '合同酒精 八戸工場', kana: 'ごうどうしゅせいはちのへこうじょう')
...
c = Company.create_or_find_by!(name: '八戸酒類 八鶴工場', kana: 'はちのへしゅるい はちつるこうじょう')
...
c = Company.create_or_find_by!(name: '八戸酒造', kana: 'はちのへしゅぞう')
...
c = Company.create_or_find_by!(name: '鳩正宗', kana: 'はとまさむね')
...
c = Company.create_or_find_by!(name: '関乃井酒造', kana: 'せきのいしゅぞう')
...
c = Company.create_or_find_by!(name: '中村亀吉', kana: 'なかむらかめきち')
...
c = Company.create_or_find_by!(name: '鳴海醸造店', kana: 'なるみじょうぞうてん')
address_attrs = { prefecture_code: 2, city: '黒石市', street_address: '大字中町1-1', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
contact_attrs = { tel: '0172-52-3321', fax: '0172-52-3819', website: 'http://www.applet1181.jp/kikunoi' }
c.contact || c.create_contact!(contact_attrs)
...
c = Company.create_or_find_by!(name: '丸竹酒造店', kana: 'まるたけしゅぞうてん')
...
c = Company.create_or_find_by!(name: '白神酒造', kana: 'しらかみしゅぞう')
...
c = Company.create_or_find_by!(name: '六花酒造', kana: 'ろっかしゅぞう')
...
c = Company.create_or_find_by!(name: '弘前銘醸', kana: 'ひろさきめいじょう')
...
c = Company.create_or_find_by!(name: 'カネタ玉田酒造店', kana: 'かねたたまだしゅぞうてん')
...
c = Company.create_or_find_by!(name: '松緑酒造', kana: 'まつみどりしゅぞう')
...
c = Company.create_or_find_by!(name: '竹浪酒造店', kana: 'たけなみしゅぞうてん')
...
c = Company.create_or_find_by!(name: '長内酒造店', kana: 'おさないしゅぞうてん')
address_attrs = { prefecture_code: 2, addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
Brand.find_or_create_by!(name: '明ケ烏', kana: 'あけがらす', company: c)

c = Company.create_or_find_by!(name: '西田酒造店', kana: 'にしだしゅぞうてん')
...
c = Company.create_or_find_by!(name: '八戸酒類 第二工場', kana: 'はちのへしゅるい だいにこうじょう')
address_attrs = { prefecture_code: 2, addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
Brand.find_or_create_by!(name: '稲川', kana: 'いながわ', company: c)

c = Company.create_or_find_by!(name: '八戸酒類 五戸工場', kana: 'はちのへしゅるい ごのへこうじょう')
...
c = Company.create_or_find_by!(name: '菊駒酒造', kana: 'きくこましゅぞう')
address_attrs = { prefecture_code: 2, city: '三戸郡', street_address: '五戸町字川原町12', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
...
c = Company.create_or_find_by!(name: '桃川', kana: 'ももかわ')
...
c = Company.create_or_find_by!(name: '盛田庄兵衛', kana: 'もりたしょうべえ')

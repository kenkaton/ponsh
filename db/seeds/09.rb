c = Company.in_prefecture(9).find_or_create_by!(name: '虎屋本店', kana: 'とらやほんてん')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '小林杢三郎商店', kana: 'こばやしもくさぶろうしょうてん')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '島崎酒造', kana: 'しまざきしゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '宇都宮酒造', kana: 'うつのみやしゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '外池荘五郎商店', kana: 'とのいけしょうごろうしょうてん')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '渡辺佐平商店', kana: 'わたなべさへいしょうてん')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '片山酒造', kana: 'かたやましゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '惣誉酒造', kana: 'そうほまれしゅぞう')
...
c.contact || c.create_contact!(contact_attrs)
Brand.find_or_create_by!(name: '惣譽', kana: 'そうほまれ', company: c) # 惣誉
Brand.find_or_create_by!(name: '帰一', kana: 'きいつ', company: c)


c = Company.in_prefecture(9).find_or_create_by!(name: '島崎泉治商店', kana: 'しまざきせんじしょうてん')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '外池酒造店', kana: 'とのいけしゅぞうてん')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '辻善兵衛商店', kana: 'つじぜんべえしょうてん')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '飯沼銘醸', kana: 'いいぬまめいじょう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '若駒酒造', kana: 'わかこましゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '杉田酒造', kana: 'すぎたしゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '三福酒造', kana: 'さんぷくしゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '小林酒造', kana: 'こばやししゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '平山酒造店', kana: 'ひらやましゅぞうてん')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '池島酒造', kana: 'いけしましゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '鳳鸞酒造', kana: 'ほうらんしゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '渡辺酒造', kana: 'わたなべしゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '天鷹酒造', kana: 'てんたかしゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '菊の里酒造', kana: 'きくのさとしゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '白相酒造', kana: 'しらそうしゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '金子酒造', kana: 'かねこしゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '和泉酒造店', kana: 'いずみしゅぞうてん')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '吉井酒造', kana: 'よしいしゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '第一酒造', kana: 'だいいちしゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '相沢酒造', kana: 'あいざわしゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '北関酒造', kana: 'ほっかんしゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '西堀酒造', kana: 'にしぼりしゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '井上清吉商店', kana: 'いのうえせいきちしょうてん')
...
c = Company.in_prefecture(9).find_or_create_by!(name: 'せんきん', kana: 'せんきん')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '富川酒造店', kana: 'とみかわしゅぞうてん')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '小島酒造店', kana: 'こじましゅぞうてん')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '松井酒造店', kana: 'まついしゅぞうてん')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '森戸酒造', kana: 'もりとしゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '相良酒造', kana: 'さがらしゅぞう')
...
c = Company.in_prefecture(9).find_or_create_by!(name: '大平酒造', kana: 'おおひらしゅぞう')

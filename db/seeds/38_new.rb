c = Company.create_or_find_by!(name: '岡酒造', kana: 'おかしゅぞう')
...
c = Company.create_or_find_by!(name: '愛媛県酒造共同組合', kana: 'えひめけんしゅぞうきょうどうくみあい')
...
c = Company.create_or_find_by!(name: '水口酒造', kana: 'みなくちしゅぞう')
...
c = Company.create_or_find_by!(name: '栄光酒造', kana: 'えいこうしゅぞう')
...
c = Company.create_or_find_by!(name: '横河酒造', kana: 'よこかわしゅぞう')
...
c = Company.create_or_find_by!(name: '島田酒造', kana: 'しまだしゅぞう')
...
c = Company.create_or_find_by!(name: 'お茂ご酒造', kana: 'おもごしゅぞう')
...
c = Company.create_or_find_by!(name: '雪娘酒造', kana: 'ゆきむすめしゅぞう')
...
c = Company.create_or_find_by!(name: 'かち鶴酒造', kana: 'かちづるしゅぞう')
...
c = Company.create_or_find_by!(name: '協和酒造', kana: 'きょうわしゅぞう')
...
c = Company.create_or_find_by!(name: '武智酒店', kana: 'たけちさけみせ')
...
c = Company.create_or_find_by!(name: '酒六酒造', kana: 'さかろくしゅぞう')
...
c = Company.create_or_find_by!(name: '蔵本屋本店', kana: 'くらもとやほんてん')
...
c = Company.create_or_find_by!(name: '石鎚酒造', kana: 'いしづちしゅぞう')
...
c = Company.create_or_find_by!(name: '八木酒造部', kana: 'やぎしゅぞうぶ')
...
c = Company.create_or_find_by!(name: '千代の亀酒造', kana: 'ちよのかめしゅぞう')
...
c = Company.create_or_find_by!(name: '梅美人酒造', kana: 'うめびじんしゅぞう')
...
c = Company.create_or_find_by!(name: '桐万長酒造', kana: 'きりまんちょうしゅぞう')
...
c = Company.create_or_find_by!(name: '川亀酒造', kana: 'かわかめしゅぞう')
...
c = Company.create_or_find_by!(name: '元見屋酒店', kana: 'もとみやさけてん')
...
c = Company.create_or_find_by!(name: '最進酒造', kana: 'さいしんしゅぞう')
...
c = Company.create_or_find_by!(name: '緒方酒造', kana: 'おがたしゅぞう')
...
c = Company.create_or_find_by!(name: '中城本家酒造', kana: 'なかしろほんけしゅぞう')
...
c = Company.create_or_find_by!(name: '名門サカイ', kana: 'めいもんさかい')
...
c = Company.create_or_find_by!(name: '西本酒造', kana: 'にしもとしゅぞう')
...
c = Company.create_or_find_by!(name: '正木正光酒造場', kana: 'まさきまさみつしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '赤松本家酒造', kana: 'あかまつほんけしゅぞう')
...
c = Company.create_or_find_by!(name: '小西酒造場', kana: 'こにししゅぞうじょう')
...
c = Company.create_or_find_by!(name: '今村酒造', kana: 'いまむらしゅぞう')
...
c = Company.create_or_find_by!(name: '梅錦山川', kana: 'うめにしきやまかわ')
...
c = Company.create_or_find_by!(name: '篠永酒造', kana: 'しのながしゅぞう')
...
c = Company.create_or_find_by!(name: '首藤酒造', kana: 'すとうしゅぞう')
...
c = Company.create_or_find_by!(name: '武田酒造', kana: 'たけだしゅぞう')
...
c = Company.create_or_find_by!(name: '秋川酒造', kana: 'あきかわしゅぞう')
...
c = Company.create_or_find_by!(name: '成龍酒造', kana: 'せいりょうしゅぞう')
...
c = Company.create_or_find_by!(name: '森松酒造場', kana: 'もりまつしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '桜うづまき酒造', kana: 'さくらうづまきしゅぞう')
...
c = Company.create_or_find_by!(name: '雪雀酒造', kana: 'ゆきすずめしゅぞう')
...
c = Company.create_or_find_by!(name: '徳本酒造', kana: 'とくもとしゅぞう')
...
c = Company.create_or_find_by!(name: '奥嶋酒造', kana: 'おくしましゅぞう')
...
c = Company.create_or_find_by!(name: '濱田酒造', kana: 'はまだしゅぞう')

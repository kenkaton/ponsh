c = Company.in_prefecture(28).find_or_create_by!(name: '丹波・篠山酒造組合', kana: 'たんばささやましゅぞうくみあい')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '都美人酒造', kana: 'みやこびじんしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '浜千鳥酒造', kana: 'はまちどりしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '千年一酒造', kana: 'せんねんいちしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '金盃酒造', kana: 'きんぱいしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '富久娘酒造', kana: 'ふくむすめしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '沢の鶴', kana: 'さわのつる')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '太田酒造 灘 千代田蔵', kana: 'おおたしゅぞう なだ ちよだぐら')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '小山本家酒造 灘浜福鶴蔵', kana: 'こやまほんけしゅぞう なだはまふくつるくら')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '松尾仁兵衛商店', kana: 'まつおにへえしょうてん')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '櫻正宗', kana: 'さくらまさむね')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '豊澤酒造', kana: 'とよざわしゅぞう')
address_attrs = { prefecture_code: 28, city: '神戸市東灘区', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.in_prefecture(28).find_or_create_by!(name: '宝酒造 白壁蔵', kana: 'たからしゅぞう しらかべぐら')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '白鶴酒造', kana: 'はくつるしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '安福又四郎商店', kana: 'やすふくまたしろうしょうてん')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '泉酒造', kana: 'いずみしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '神戸酒心館', kana: 'こうべしゅしんかん')
...
c.contact || c.create_contact!(contact_attrs)
Brand.find_or_create_by!(name: '福壽', kana: 'ふくじゅ', company: c) # 福寿
Brand.find_or_create_by!(name: '壱', kana: 'いち', company: c)


c = Company.in_prefecture(28).find_or_create_by!(name: '坊垣醸造', kana: 'ぼうがきじょうぞう')
address_attrs = { prefecture_code: 28, city: '神戸市東灘区', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.in_prefecture(28).find_or_create_by!(name: '剣菱酒造', kana: 'けんびししゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '菊正宗酒造', kana: 'きくまさむねしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '日本盛', kana: 'にほんさかり')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '万代大澤醸造', kana: 'まんだいおおさわじょうぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '國産酒造', kana: 'こくさんしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '大澤本家酒造', kana: 'おおさわほんけしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '本野田酒造', kana: 'ほんのだしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '木谷酒造', kana: 'きたにしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '松竹梅酒造', kana: 'しょうちくばいしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '白鷹', kana: 'はくたか')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '北山酒造', kana: 'きたやましゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '辰馬本家酒造', kana: 'たつうまほんけしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '灘酒造', kana: 'なだしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '大関', kana: 'おおぜき')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '今津酒造', kana: 'いまづしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '伊丹老松酒造', kana: 'いたみおいまつしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '小西酒造', kana: 'こにししゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '川辺酒造', kana: 'かわべしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '八鹿酒造', kana: 'ようかしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '銀海酒造', kana: 'ぎんかいしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '出石酒造', kana: 'いずししゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '安井酒造', kana: 'やすいしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '岡村酒造場', kana: 'おかむらしゅぞうじょう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '狩場一酒造', kana: 'かりばいちしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '鳳鳴酒造', kana: 'ほうめいしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '櫻酒造', kana: 'さくらしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '打田酒造', kana: 'うちだしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '中大槻酒造場', kana: 'なかおおつきしゅぞうじょう')
address_attrs = { prefecture_code: 28, city: '丹波市', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.in_prefecture(28).find_or_create_by!(name: '西山酒造場', kana: 'にしやましゅぞうじょう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '鴨庄酒造', kana: 'かものしょうしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '山名酒造', kana: 'やまなしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '此の友酒造', kana: 'このともしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '田治米', kana: 'たじめ')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '友田酒造', kana: 'ともだしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '香住鶴', kana: 'かすみつる')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '吉村酒造', kana: 'よしむらしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '灘菊酒造', kana: 'なだぎくしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '田中酒造場', kana: 'たなかしゅぞうじょう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '本田商店', kana: 'ほんだしょうてん')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '松尾酒造', kana: 'まつおしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '壺坂酒造', kana: 'つぼさかしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '下村酒造店', kana: 'しもむらしゅぞうてん')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '山陽盃酒造', kana: 'さんようはいしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '老松酒造', kana: 'おいまつしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '稲見酒造', kana: 'いなみしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '福太醸造', kana: 'ふくたじょうぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '明石酒類醸造', kana: 'あかししゅるいじょうぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '大熊酒造', kana: 'おおくましゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '櫻井酒造', kana: 'さくらいしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '太陽酒造', kana: 'たいようしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '大和酒造', kana: 'だいわしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '江井ヶ嶋酒造', kana: 'えいがしましゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '西海酒造', kana: 'にしうみしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '茨木酒造', kana: 'いばらきしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '岡田本家', kana: 'おかだほんけ')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '木戸酒造', kana: 'きどしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '井澤本家', kana: 'いざわほんけ')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '大西酒造', kana: 'おおにししゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: 'キング醸造', kana: 'きんぐしょうぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '服部酒造', kana: 'はっとりしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '田中酒造', kana: 'たなかしゅぞう')
address_attrs = { prefecture_code: 28, city: '小野市', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.in_prefecture(28).find_or_create_by!(name: '三宅酒造', kana: 'みやけしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '富久錦', kana: 'ふくにしき')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '西谷酒造', kana: 'にしたにしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '奥藤商事', kana: 'おくとうしょうじ')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '神結酒造', kana: 'かみむすびしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '高徳銘醸', kana: 'たかのりめいじょう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '神崎酒造', kana: 'かんざきしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '名城酒造', kana: 'めいじょうしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: 'ヤヱガキ酒造', kana: 'やえがきしゅぞう')
...
c = Company.in_prefecture(28).find_or_create_by!(name: '木村酒造場', kana: 'きむらしゅぞうじょう')

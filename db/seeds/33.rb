c = Company.in_prefecture(33).find_or_create_by!(name: '岡山ZARU', kana: 'おかやまざる')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '萬歳酒造', kana: 'ばんざいしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '板野酒造場', kana: 'いたのしゅぞうじょう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '板野酒造本店', kana: 'いたのしゅぞうほんてん')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '利守酒造', kana: 'としもりしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '小坂酒造', kana: 'こさかしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '小宮山酒造', kana: 'こみやましゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '山本酒造', kana: 'やまもとしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '遠藤酒造場', kana: 'えんどうしゅぞうじょう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '服部本家酒造場', kana: 'はっとりほんけしゅぞうじょう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '高祖酒造', kana: 'こうそしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '宮下酒造', kana: 'みやしたしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '小林本店', kana: 'こばやしほんてん')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '玉泉酒造', kana: 'たまいずみしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '藤原酒造', kana: 'ふじわらしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '東郷酒造', kana: 'とうごうしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '田中酒造場', kana: 'たなかしゅぞうじょう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '後藤酒造', kana: 'ごとうしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '牧野酒造本店', kana: 'まきのしゅぞうほんてん')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '難波酒造', kana: 'なんばしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '苅田酒造エネルギー', kana: 'かんだしゅぞうえねるぎー')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '多胡本家酒造場', kana: 'たごほんけしゅぞうじょう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '金剛酒造', kana: 'こんごうしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '赤磐酒造', kana: 'あかいわしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '室町酒造', kana: 'むろまちしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '旭鶴酒造', kana: 'あさひつるしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '森田酒造', kana: 'もりたしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '熊屋酒造', kana: 'くまやしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '白神酒造', kana: 'しらがしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '十八盛酒造', kana: 'じゅうはちざかりしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '三冠酒造', kana: 'さんかんしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '大野酒造', kana: 'おおのしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '渡辺酒造本店', kana: 'わたなべしゅぞうほんてん')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '中田酒造', kana: 'なかたしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '三千鶴酒造', kana: 'みちつるしゅぞう')
address_attrs = { prefecture_code: 33, city: '倉敷市', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.in_prefecture(33).find_or_create_by!(name: '菊池酒造', kana: 'きくちしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '不二菊酒造本店', kana: 'ふじぎくしゅぞうほんてん')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '酔宝酒造', kana: 'すいほうしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '大内酒造場', kana: 'おおうちしゅぞうじょう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '嘉美心酒造', kana: 'かみこころしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '山成酒造', kana: 'やまなりしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '瀧本酒造', kana: 'たきもとしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '白菊酒造', kana: 'しらぎくしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '赤木酒造', kana: 'あかぎしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '小出酒造', kana: 'こいでしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '芳烈酒造', kana: 'ほうれつしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '落酒造場', kana: 'おちしゅぞうじょう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '辻本店', kana: 'つじほんてん')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '大美酒造', kana: 'おおみしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '神露酒造', kana: 'しんろしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '丸本酒造', kana: 'まるもとしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '平喜酒造', kana: 'ひらきしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '藤田酒造', kana: 'ふじたしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '磯千鳥酒造', kana: 'いそちどりしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '松永酒造', kana: 'まつながしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '三宅酒造', kana: 'みやけしゅぞう')
...
c = Company.in_prefecture(33).find_or_create_by!(name: 'ヨイキゲン', kana: 'よいきげん')
...
c = Company.in_prefecture(33).find_or_create_by!(name: '三光正宗', kana: 'さんこうまさむね')

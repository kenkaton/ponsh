c = Company.create_or_find_by!(name: '斎藤酒造場', kana: 'さいとうしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '吉本醸造', kana: 'よしもとじょうぞう')
...
c = Company.create_or_find_by!(name: '勢玉酒造', kana: 'せいぎょくしゅぞう')
...
c = Company.create_or_find_by!(name: '木内本店', kana: 'きのうちほんてん')
...
c = Company.create_or_find_by!(name: '日新酒類 太閤酒造場', kana: 'にっしんしゅるい たいこうしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '司菊酒造', kana: 'つかさぎくしゅぞう')
...
c = Company.create_or_find_by!(name: '明星酒造', kana: 'みょうじょうしゅぞう')
...
c = Company.create_or_find_by!(name: '名西酒造', kana: 'みょうざいしゅぞう')
...
c = Company.create_or_find_by!(name: '定作酒類醸造場', kana: 'じょうつくりしゅるいじょうぞうじょう')
...
c = Company.create_or_find_by!(name: '那賀酒造', kana: 'なかしゅぞう')
...
c = Company.create_or_find_by!(name: '花乃春酒造', kana: 'はなのはるしゅぞう')
...
c = Company.create_or_find_by!(name: '三拍子酒造', kana: 'さんびょうししゅぞう')
...
c = Company.create_or_find_by!(name: '鳴門酒造', kana: 'なるとしゅぞう')
...
c = Company.create_or_find_by!(name: '津乃峰酒造', kana: 'つのみねしゅぞう')
...
c = Company.create_or_find_by!(name: '真野武酒造', kana: 'まのたけしゅぞう')
...
c = Company.create_or_find_by!(name: '三芳菊酒造', kana: 'みよしきくしゅぞう')
...
c = Company.create_or_find_by!(name: '中和商店', kana: 'なかわしょうてん')
...
c = Company.create_or_find_by!(name: '矢川酒造', kana: 'やがわしゅぞう')
...
c = Company.create_or_find_by!(name: '本家松浦酒造場', kana: 'ほんけまつうらしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '近清酒造', kana: 'ちかきよしゅぞう')
...
c = Company.create_or_find_by!(name: '近藤松太郎商店', kana: 'こんどうまつたろうしょうてん')
...
c = Company.create_or_find_by!(name: '阿川酒造', kana: 'あがわしゅぞう')
...
c = Company.create_or_find_by!(name: '可楽智酒造', kana: 'からくちしゅぞう')
...
c = Company.create_or_find_by!(name: '芳水酒造', kana: 'ほうすいしゅぞう')

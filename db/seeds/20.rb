c = Company.in_prefecture(20).find_or_create_by!(name: '59醸', kana: 'ごくじょう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: 'SAKU13', kana: 'さくさーてぃーん')
address_attrs = { prefecture_code: 20, city: '', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
...
c = Company.in_prefecture(20).find_or_create_by!(name: '信州醸熱タンク', kana: 'しんしゅうじょうねつたんく')
address_attrs = { prefecture_code: 20, city: '', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
Brand.find_or_create_by!(name: '信州醸熱タンク', kana: 'しんしゅうじょうねつたんく', company: c)


c = Company.in_prefecture(20).find_or_create_by!(name: 'よしのや', kana: 'よしのや')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '今井酒造店', kana: 'いまいしゅぞうてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '松葉屋本店', kana: 'まつばやほんてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '桝一市村酒造場', kana: 'ますいちいちむらしゅぞうじょう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '高沢酒造', kana: 'たかさわしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '小布施ワイナリー', kana: 'おぶせわいなりー')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '玉村本店', kana: 'たまむらほんてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '松代宮坂酒造店', kana: 'まつしろみやさかしゅぞうてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '横綱酒造', kana: 'よこづなしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '酒千蔵野', kana: 'しゅせんくらの')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '東飯田酒造店', kana: 'ひがしいいだしゅぞうてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '西飯田酒造店', kana: 'にしいいだしゅぞうてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '尾澤酒造場', kana: 'おざわしゅぞうじょう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '遠藤酒造場', kana: 'えんどうしゅぞうじょう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '松葉屋', kana: 'まつばや')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '井賀屋酒造場', kana: 'いがやしゅぞうじょう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '丸世酒造店', kana: 'まるせしゅぞうてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '志賀泉酒造', kana: 'しがいずみしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '天領誉酒造', kana: 'てんりょうほまれしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '大塚酒造', kana: 'おおつかしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '橘倉酒造', kana: 'きつくらしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '佐久の花酒造', kana: 'さくのはなしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '黒澤酒造', kana: 'くろさわしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '大澤酒造', kana: 'おおさわしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '武重本家酒造', kana: 'たけしげほんけしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '千曲錦酒造', kana: 'ちくまにしきしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '戸塚酒造店', kana: 'とつかしゅぞうてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '古屋酒造店', kana: 'ふるやしゅぞうてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '芙蓉酒造', kana: 'ふようしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '木内醸造', kana: 'きうちじょうぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '土屋酒造店', kana: 'つちやしゅぞうてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '伴野酒造', kana: 'とものしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '岡崎酒造', kana: 'おかざきしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '和田龍酒造', kana: 'わだりゅうしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '沓掛酒造', kana: 'くつかけしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '信州銘醸', kana: 'しんしゅうめいじょう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '山三酒造', kana: 'やまさんしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '若林醸造', kana: 'わかばやしじょうぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '長野銘醸', kana: 'ながのめいじょう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '天法酒造', kana: 'てんぽうしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '坂井銘醸', kana: 'さかいめいじょう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '高橋助作酒造店', kana: 'たかはしすけさくしゅぞうてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '田中屋酒造店', kana: 'たなかやしゅぞうてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '角口酒造店', kana: 'かどぐちしゅぞうてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '岩波酒造', kana: 'いわなみしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '奥澤商会', kana: 'おくざわしょうかい')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '笹井酒造', kana: 'ささいしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '亀田屋酒造店', kana: 'かめたやしゅぞうてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '大信州酒造', kana: 'だいしんしゅうしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '善哉酒造', kana: 'よいかなしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '諏訪大津屋本家酒造', kana: 'すわおおつやほんけしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '伊東酒造', kana: 'いとうしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '舞姫酒造', kana: 'まいひめしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '酒ぬのや本金酒造', kana: 'さけぬのやほんきんしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '麗人酒造', kana: 'れいじんしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '宮坂醸造', kana: 'みやさかじょうぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '諏訪御湖鶴酒造場', kana: 'すわみこつるしゅぞうじょう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '高天酒造', kana: 'こうてんしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '豊島屋', kana: 'としまや')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '喜久水酒造', kana: 'きくすいしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '漆戸醸造', kana: 'うるしどじょうぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '宮島酒店', kana: 'みやじまさけてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '仙醸', kana: 'せんじょう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '七笑酒造', kana: 'ななわらいしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '中善酒造店', kana: 'なかぜんしゅぞうてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '北安醸造', kana: 'ほくあんじょうぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '市野屋', kana: 'いちのや')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '薄井商店', kana: 'うすいしょうてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '小野酒造店', kana: 'おのしゅぞうてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '丸永酒造場', kana: 'まるながしゅぞうじょう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '笑亀酒造', kana: 'しょうきしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '米澤酒造', kana: 'よねざわしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '長生社', kana: 'ちょうせいしゃ')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '大國酒造', kana: 'おおくにしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '山岸酒店', kana: 'やまぎしさけてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '西尾酒造', kana: 'にしおしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '湯川酒造店', kana: 'ゆかわしゅぞうてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '杉の森酒造 suginomori brewery', kana: 'すぎのもりしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '美寿々酒造', kana: 'みすずしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '明科酒造', kana: 'あかしなしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '菊水醸造店', kana: 'きくすいじょうぞうてん')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '山清酒造', kana: 'さんせいしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: 'EH酒造', kana: 'いーえいちしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '福源酒造', kana: 'ふくげんしゅぞう')
...
c = Company.in_prefecture(20).find_or_create_by!(name: '大雪渓酒造', kana: 'だいせっけいしゅぞう')

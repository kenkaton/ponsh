c = Company.in_prefecture(40).find_or_create_by!(name: '福岡銘酒会', kana: 'ふくおかめいしゅかい')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '無法松酒造', kana: 'むほうまつしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '溝上酒造', kana: 'みぞかみしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '花関酒造', kana: 'はなのせきしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '小林酒造本店', kana: 'こばやししゅぞうほんてん')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '光酒造', kana: 'ひかりしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '翁酒造', kana: 'おきなしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '豊村酒造', kana: 'とよむらしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '鷲頭酒造場', kana: 'わしずしゅぞうじょう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '勝屋酒造', kana: 'かつやしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '伊豆本店', kana: 'いずほんてん')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '石蔵酒造', kana: 'いしくらしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '綾杉酒造場', kana: 'あやすぎしゅぞうじょう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '大賀酒造', kana: 'おおがしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '浜地酒造', kana: 'はまちしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '白糸酒造', kana: 'しらいとしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '薫仙', kana: 'くんせん')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '瑞穂菊酒造', kana: 'みずほぎくしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '寒北斗酒造', kana: 'かんほくとしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '梅ヶ谷酒造', kana: 'うめがたにしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '大里酒造', kana: 'おおさとしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '石井産業', kana: 'いしいさんぎょう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '林龍平酒造場', kana: 'はやしりゅうへいしゅぞうじょう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '戸渡酒造', kana: 'とわたりしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '福太郎', kana: 'ふくたろう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '後藤酒造', kana: 'ごとうしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '鷹正宗', kana: 'たかまさむね')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '瑞穂錦酒造', kana: 'みずほにしきしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '池亀酒造', kana: 'いけかめしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '萬年亀酒造', kana: 'まんねんがめしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '杜の蔵', kana: 'もりのくら')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '旭菊酒造', kana: 'あさひぎくしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '有薫酒造', kana: 'ゆうくんしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '花の露', kana: 'はなのつゆ')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '比翼鶴酒造', kana: 'ひよくつるしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '千年乃松酒造', kana: 'ちとせのまつしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '山口酒造場', kana: 'やまぐちしゅぞうじょう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '山の壽酒造', kana: 'やまのことぶきしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '飛龍酒造', kana: 'ひりゅうしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: 'みいの寿', kana: 'みいのことぶき')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '筑紫の誉酒造', kana: 'ちくしのほまれしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '若波酒造', kana: 'わかなみしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '蔵内堂', kana: 'くらうちどう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '柳川酒造', kana: 'やながわしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '喜多屋', kana: 'きたや')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '福島酒造', kana: 'ふくしましゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '高橋商店', kana: 'たかはししょうてん')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '後藤酒造場', kana: 'ごとうしゅぞうじょう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '旭松酒造', kana: 'あさひまつしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '野田酒造', kana: 'のだしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '星隈酒造', kana: 'ほしくましゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '池田屋', kana: 'いけだや')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '菊美人酒造', kana: 'きくびじんしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '玉水酒造', kana: 'たまみずしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '江頭酒造', kana: 'えがしらしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '朝倉酒造', kana: 'あさくらしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '雪の里酒造', kana: 'ゆきのさとしゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '森山酒造', kana: 'もりやましゅぞう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '篠崎', kana: 'しのざき')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '安岡酒造場', kana: 'やすおかしゅぞうじょう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '片岡酒造場', kana: 'かたおかしゅぞうじょう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '朝凪酒造', kana: 'あさなぎしゅぞう')
address_attrs = { prefecture_code: 40, city: '久留米市', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.in_prefecture(40).find_or_create_by!(name: '若竹屋酒造場', kana: 'わかたけやしゅぞうじょう')
...
c = Company.in_prefecture(40).find_or_create_by!(name: 'いそのさわ', kana: 'いそのさわ')
...
c = Company.in_prefecture(40).find_or_create_by!(name: '高野酒造場', kana: 'たかのしゅぞうじょう')

c = Company.create_or_find_by!(name: 'ぷくぷく醸造', kana: 'ぷくぷくじょうぞう')
...
c = Company.create_or_find_by!(name: '喜多方・坂下・高田エリア14蔵', kana: '')
...
c = Company.create_or_find_by!(name: '會津アクティベートアソシエーション株式会社', kana: 'あいづあくてぃべーとあそしえーしょん')
address_attrs = { prefecture_code: 7, city: '', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
...
c = Company.create_or_find_by!(name: '金水晶酒造店', kana: 'きんすいしょうしゅぞうてん')
...
c = Company.create_or_find_by!(name: '有賀醸造', kana: 'ありがじょうぞう')
...
c = Company.create_or_find_by!(name: '千駒酒造', kana: 'せんこましゅぞう')
...
c = Company.create_or_find_by!(name: '大谷忠吉本店', kana: 'おおやちゅうきちほんてん')
...
c = Company.create_or_find_by!(name: '白河銘醸', kana: 'しらかわめいじょう')
...
c = Company.create_or_find_by!(name: '寿々乃井酒造店', kana: 'すずのいしゅぞうてん')
...
c = Company.create_or_find_by!(name: '松崎酒造店', kana: 'まつざきしゅぞうてん')
...
c = Company.create_or_find_by!(name: '笹の川酒造', kana: 'ささのかわしゅぞう')
...
c = Company.create_or_find_by!(name: '仁井田本家', kana: 'にいだほんけ')
...
c = Company.create_or_find_by!(name: '小泉合名', kana: 'こいずみ')
...
c = Company.create_or_find_by!(name: '秋元酒造店', kana: 'あきもとしゅぞうてん')
...
c = Company.create_or_find_by!(name: '玄葉本店', kana: 'げんばほんてん')
...
c = Company.create_or_find_by!(name: '矢澤酒造店', kana: 'やざわしゅぞうてん')
...
c = Company.create_or_find_by!(name: '家満寿美', kana: 'やますみ')
...
c = Company.create_or_find_by!(name: '藤田屋本店', kana: 'ふじたやほんてん')
...
c = Company.create_or_find_by!(name: '三春酒造', kana: 'みはるしゅぞう')
...
c = Company.create_or_find_by!(name: '若清水酒造', kana: 'わかしみずしゅぞう')
...
c = Company.create_or_find_by!(name: '豊国酒造', kana: 'とよくにしゅぞう')
...
c = Company.create_or_find_by!(name: '若関酒造', kana: 'わかぜきしゅぞう')
...
c = Company.create_or_find_by!(name: '人気酒造', kana: 'にんきしゅぞう')
...
c = Company.create_or_find_by!(name: '奥の松酒造', kana: 'おくのまつしゅぞう')
...
c = Company.create_or_find_by!(name: '大七酒造', kana: 'だいしちしゅぞう')
...
c = Company.create_or_find_by!(name: '檜物屋酒造店', kana: 'ひものやしゅぞうてん')
...
c = Company.create_or_find_by!(name: '大内酒造', kana: 'おおうちしゅぞう')
...
c = Company.create_or_find_by!(name: '山口合名', kana: 'やまぐちごうめい')
...
c = Company.create_or_find_by!(name: '柏木酒造店', kana: 'かしわぎしゅぞうてん')
address_attrs = { prefecture_code: 7, city: '会津若松市', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.create_or_find_by!(name: '辰泉酒造', kana: 'たついずみしゅぞう')
...
c = Company.create_or_find_by!(name: '鶴乃江酒造', kana: 'つるのえしゅぞう')
...
c = Company.create_or_find_by!(name: '花春酒造', kana: 'はなはるしゅぞう')
...
c = Company.create_or_find_by!(name: '名倉山酒造', kana: 'なぐらやましゅぞう')
...
c = Company.create_or_find_by!(name: '高橋庄作酒造店', kana: 'たかはししょうさくしゅぞうてん')
...
c = Company.create_or_find_by!(name: '石橋酒造場', kana: 'いしばししゅぞうじょう')
...
c = Company.create_or_find_by!(name: '末廣酒造', kana: 'すえひろしゅぞう')
...
c = Company.create_or_find_by!(name: '宮泉銘醸', kana: 'みやいずみめいじょう')
...
c = Company.create_or_find_by!(name: '夢心酒造', kana: 'ゆめごころしゅぞう')
...
c = Company.create_or_find_by!(name: '小原酒造', kana: 'おはらしゅぞう')
...
c = Company.create_or_find_by!(name: '峰の雪酒造場', kana: 'みねのゆきしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '清川商店', kana: 'きよかわしょうてん')
...
c = Company.create_or_find_by!(name: '吉の川酒造店', kana: 'よしのがわしゅぞうてん')
...
c = Company.create_or_find_by!(name: '大和川酒造店', kana: 'やまとがわしゅぞうてん')
...
c = Company.create_or_find_by!(name: '喜多の華酒造場', kana: 'きたのはなしゅぞうじょう')
...
c = Company.create_or_find_by!(name: 'ほまれ酒造', kana: 'ほまれしゅぞう')
...
c = Company.create_or_find_by!(name: '香久山', kana: 'かぐやま')
...
c = Company.create_or_find_by!(name: '笹正宗酒造', kana: 'ささまさむねしゅぞう')
...
c = Company.create_or_find_by!(name: '国権酒造', kana: 'こっけんしゅぞう')
...
c = Company.create_or_find_by!(name: '開当男山酒造', kana: 'かいとうおとこやましゅぞう')
...
c = Company.create_or_find_by!(name: '会津酒造', kana: 'あいづしゅぞう')
...
c = Company.create_or_find_by!(name: '花泉酒造', kana: 'はないずみしゅぞう')
...
c = Company.create_or_find_by!(name: 'ねっか', kana: 'ねっか')
...
c = Company.create_or_find_by!(name: '大木代吉本店', kana: 'おおきだいきちほんてん')
...
c = Company.create_or_find_by!(name: '清鏡酒造', kana: 'きよかがみしゅぞう')
...
c = Company.create_or_find_by!(name: '大天狗酒造', kana: 'だいてんぐしゅぞう')
...
c = Company.create_or_find_by!(name: '稲川酒造店', kana: 'いながわしゅぞうてん')
...
c = Company.create_or_find_by!(name: '磐梯酒造', kana: 'ばんだいしゅぞう')
...
c = Company.create_or_find_by!(name: '榮川酒造', kana: 'えいせんしゅぞう')
...
c = Company.create_or_find_by!(name: '会津錦', kana: 'あいづにしき')
...
c = Company.create_or_find_by!(name: '栄川酒造', kana: 'さかえがわしゅぞう')
address_attrs = { prefecture_code: 7, city: '耶麻郡', street_address: '西会津町野沢本町甲1184', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
contact_attrs = { tel: '0241-45-2013', fax: '0241-45-2742', contactable_type: 'Company' }
c.contact || c.create_contact!(contact_attrs)
...
c = Company.create_or_find_by!(name: '男山酒造店', kana: 'おとこやましゅぞうてん')
...
c = Company.create_or_find_by!(name: '白井酒造店', kana: 'しらいしゅぞうてん')
...
c = Company.create_or_find_by!(name: '曙酒造', kana: 'あけぼのしゅぞう')
...
c = Company.create_or_find_by!(name: '廣木酒造本店', kana: 'ひろきしゅぞうほんてん')
...
c = Company.create_or_find_by!(name: '豊田酒造場', kana: 'とよたしゅぞうじょう')
...
c = Company.create_or_find_by!(name: '常磐酒類', kana: 'じょうばんしゅるい')
...
c = Company.create_or_find_by!(name: '御代酒造店', kana: 'みよしゅぞうてん')
...
c = Company.create_or_find_by!(name: '太平桜酒造', kana: 'たいへいざくらしゅぞう')
...
c = Company.create_or_find_by!(name: '四家酒造店', kana: 'しけしゅぞうてん')
...
c = Company.create_or_find_by!(name: '鷺酒造店', kana: 'さぎしゅぞうてん')
...
c = Company.create_or_find_by!(name: '冨沢酒造店', kana: 'とみざわしゅぞうてん')
...
c = Company.create_or_find_by!(name: '馬場酒造本店', kana: 'ばばしゅぞうほんてん')
...
c = Company.create_or_find_by!(name: '上田善治郎商店', kana: 'うえだぜんじろうしょうてん')
address_attrs = { prefecture_code: 7, city: '双葉郡', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)

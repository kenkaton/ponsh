c = Company.in_prefecture(25).find_or_create_by!(name: '平井商店', kana: 'ひらいしょうてん')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '浪乃音酒造', kana: 'なみのおとしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '滋賀県酒造組合', kana: 'しがしゅぞうくみあい')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '月の里酒造', kana: 'つきのさとしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '福井弥平商店', kana: 'ふくいやへいしょうてん')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '川島酒造', kana: 'かわしましゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '上原酒造', kana: 'うえはらしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '七洋酒造', kana: 'しちようしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '池本酒造', kana: 'いけもとしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '吉田酒造', kana: 'よしだしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '暁酒造', kana: 'あかつきしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '宇野勝酒造場', kana: 'うのまさるしゅぞうじょう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '宇野酒造', kana: 'うのしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '徳田酒造', kana: 'とくだしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '松瀬酒造', kana: 'まつせしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '服部岩彦酒造場', kana: 'はっとりいわひこしゅぞうじょう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '竹内酒造', kana: 'たけうちしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '北島酒造', kana: 'きたじましゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '重田酒造', kana: 'しげたしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '中村酒造', kana: 'なかむらしゅぞう')
address_attrs = { prefecture_code: 25, city: '甲賀市', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.in_prefecture(25).find_or_create_by!(name: '瀬古酒造', kana: 'せこしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '望月酒造', kana: 'もちづきしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '田中酒造', kana: 'たなかしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '前川酒造', kana: 'まえかわしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '増本酒造場', kana: 'ますもとしゅぞうじょう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '音瀬酒造場', kana: 'おとせしゅぞうじょう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '多賀', kana: 'たが')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '西勝酒造', kana: 'にしかつしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '宇野本家', kana: 'うのほんけ')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '金盛酒造', kana: 'きんせいしゅぞう')
address_attrs = { prefecture_code: 25, city: '守山市', street_address: '', addressable_type: 'Company' }
c.address || c.create_address!(address_attrs)
CompanyStatusHistory.create!(company: c, event_type: :status_change, business_status: :closed)
...
c = Company.in_prefecture(25).find_or_create_by!(name: '太田酒造', kana: 'おおたしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '古川酒造', kana: 'ふるかわしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '佐野酒造', kana: 'さのしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '佐藤酒造', kana: 'さとうしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '近江酒造', kana: 'おうみしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '喜多酒造', kana: 'きたしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '奥野酒造場', kana: 'おくのしゅぞうじょう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '畑酒造', kana: 'はたしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '西田酒造', kana: 'にしだしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '美冨久酒造', kana: 'みふくしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '笑四季酒造', kana: 'えみしきしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '滋賀酒造', kana: 'しがしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '藤本酒造', kana: 'ふじもとしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '松岡酒造', kana: 'まつおかしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '安井酒造場', kana: 'やすいしゅぞうじょう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '山岡酒造', kana: 'やまおかしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '冨田酒造', kana: 'とみたしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '山路酒造', kana: 'やまじしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '岡村本家', kana: 'おかむらほんけ')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '西沢藤平商店', kana: 'にしざわとうへいしょうてん')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '愛知酒造', kana: 'えちしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '藤居本家', kana: 'ふじいほんけ')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '中澤酒造', kana: 'なかざわしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '吉本酒造', kana: 'よしもとしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '矢尾酒造', kana: 'やおしゅぞう')
...
c = Company.in_prefecture(25).find_or_create_by!(name: '森本酒造', kana: 'もりもとしゅぞう')

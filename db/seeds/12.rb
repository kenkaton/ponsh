c = Company.in_prefecture(12).find_or_create_by!(name: '福徳長酒類', kana: 'ふくとくちょうしゅるい')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '窪田酒造', kana: 'くぼたしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '旭鶴', kana: 'あさひづる')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '飯沼本家', kana: 'いいぬまほんけ')
...
c.contact || c.create_contact!(contact_attrs)
Brand.find_or_create_by!(name: '甲子', kana: 'きのえねまさむね', company: c) # 甲子正宗
...
c = Company.in_prefecture(12).find_or_create_by!(name: '滝沢本店', kana: 'たきざわほんてん')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '東薫酒造', kana: 'とうくんしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '馬場本店酒造', kana: 'ばばほんてんしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '石上酒造', kana: 'いしがみしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '飯田酒造場', kana: 'いいだしゅぞうじょう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '小林酒造場', kana: 'こばやししゅぞうじょう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '寺田本家', kana: 'てらだほんけ')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '鍋店', kana: 'なべだな')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '飯田本家', kana: 'いいだほんけ')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '神明酒造', kana: 'しんめいしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '梅一輪酒造', kana: 'うめいちりんしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '東條酒造', kana: 'とうじょうしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '花の友', kana: 'はなのとも')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '寒菊銘醸', kana: 'かんぎくめいじょう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '青柳酒造', kana: 'あおやぎしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '守屋酒造', kana: 'もりやしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '宮崎本家', kana: 'みやざきほんけ')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '吉崎酒造', kana: 'よしざきしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '藤平酒造', kana: 'とうへいしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '宮崎酒造店', kana: 'みやざきしゅぞうてん')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '森酒造店', kana: 'もりしゅぞうてん')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '須藤本家', kana: 'すどうほんけ')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '千蔵酒造', kana: 'ちくらしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '秀楽酒造', kana: 'しゅうらくしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '亀田酒造', kana: 'かめだしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '木戸泉酒造', kana: 'きどいずみしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '豊乃鶴酒造', kana: 'とよのつるしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '和蔵酒造 貞元蔵', kana: 'わぐらしゅぞう さだもとぐら')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '和蔵酒造 竹岡蔵', kana: 'わぐらしゅぞう たけおかぐら')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '小泉酒造', kana: 'こいずみしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '石野商店', kana: 'いしのしょうてん')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '稲花酒造', kana: 'いなはなしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '岩瀬酒造', kana: 'いわせしゅぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '東灘醸造', kana: 'あずまなだじょうぞう')
...
c = Company.in_prefecture(12).find_or_create_by!(name: '吉野酒造', kana: 'よしのしゅぞう')
